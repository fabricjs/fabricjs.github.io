...
[src/shapes/Line.ts:74](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L74)
...
The coordinates get updated with [setCoords](/apidocs/classes/Line.md#setcoords).
You can calculate them without updating with [()](/apidocs/classes/Line.md#calcacoords)
...
[src/shapes/Line.ts:42](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L42)
...
[src/shapes/Line.ts:56](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L56)
...
[src/shapes/Line.ts:49](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L49)
...
[src/shapes/Line.ts:63](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L63)
...
[src/shapes/Line.ts:232](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L232)
...
[src/shapes/Line.ts:67](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L67)
...
[src/shapes/Line.ts:65](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L65)
...
[src/shapes/Line.ts:149](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L149)
...
[src/shapes/Line.ts:173](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L173)
...
[src/shapes/Line.ts:121](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L121)
...
[src/shapes/Line.ts:103](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L103)
...
[src/shapes/Line.ts:86](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L86)
...
[src/shapes/Line.ts:217](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L217)
...
[src/shapes/Line.ts:193](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L193)
...
if parent is canvas then this property is identical to [getX](/apidocs/classes/Line.md#getx)
...
if parent is canvas then this property is identical to [getY](/apidocs/classes/Line.md#gety)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value` | `number` | x position according to object's [originX](/apidocs/classes/FabricObject.md#originx) property in parent's coordinate plane\ if parent is canvas then this method is identical to [setX](/apidocs/classes/Line.md#setx) |
...
As [setXY](/apidocs/classes/Line.md#setxy), but in current parent's coordinate plane (the current group if any or the canvas)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value` | `number` | y position according to object's [originY](/apidocs/classes/FabricObject.md#originy) property in parent's coordinate plane\ if parent is canvas then this property is identical to [setY](/apidocs/classes/Line.md#sety) |
...
[src/shapes/Line.ts:159](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L159)
...
**fromElement**(`element`, `options?`, `cssRules?`): `Promise`\<[`Line`](/apidocs/classes/Line.md)\<{}, [`SerializedLineProps`](/apidocs/interfaces/SerializedLineProps.md), [`ObjectEvents`](/apidocs/interfaces/ObjectEvents.md)\>\>
...
[src/shapes/Line.ts:242](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L242)

___

### fromObject

**fromObject**\<`T`\>(`object`): `Promise`\<[`Line`](/apidocs/classes/Line.md)\<`Partial`\<[`FabricObjectProps`](/apidocs/interfaces/FabricObjectProps.md)\>, [`SerializedLineProps`](/apidocs/interfaces/SerializedLineProps.md), [`ObjectEvents`](/apidocs/interfaces/ObjectEvents.md)\>\>
...
[src/shapes/Line.ts:266](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Line.ts#L266)
