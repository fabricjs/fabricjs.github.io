...
**new Circle**\<`Props`, `SProps`, `EventSpec`\>(`options?`): [`Circle`](/apidocs/classes/Circle.md)\<`Props`, `SProps`, `EventSpec`\>
...
The coordinates get updated with [setCoords](/apidocs/classes/Circle.md#setcoords).
You can calculate them without updating with [()](/apidocs/classes/Circle.md#calcacoords)
...
[src/shapes/Circle.ts:62](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L62)
...
[src/shapes/Circle.ts:60](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L60)
...
[src/shapes/Circle.ts:61](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L61)
...
[src/shapes/Circle.ts:194](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L194)
...
[src/shapes/Circle.ts:66](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L66)
...
[src/shapes/Circle.ts:68](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L68)
...
[src/shapes/Circle.ts:64](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L64)
...
[src/shapes/Circle.ts:96](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L96)
...
**_set**(`key`, `value`): [`Circle`](/apidocs/classes/Circle.md)\<`Props`, `SProps`, `EventSpec`\>
...
[src/shapes/Circle.ts:82](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L82)
...
[src/shapes/Circle.ts:152](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L152)
...
| Name | Type |
| :------ | :------ |
| `T` | extends [`Circle`](/apidocs/classes/Circle.md)\<`Props`, `SProps`, `EventSpec`, `T`\> |
| `S` | extends `boolean` |
...
[src/shapes/Circle.ts:113](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L113)
...
[src/shapes/Circle.ts:121](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L121)
...
if parent is canvas then this property is identical to [getX](/apidocs/classes/Circle.md#getx)
...
if parent is canvas then this property is identical to [getY](/apidocs/classes/Circle.md#gety)
...
**set**(`key`, `value?`): [`Circle`](/apidocs/classes/Circle.md)\<`Props`, `SProps`, `EventSpec`\>
...
[src/shapes/Circle.ts:128](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L128)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value` | `number` | x position according to object's [originX](/apidocs/classes/FabricObject.md#originx) property in parent's coordinate plane\ if parent is canvas then this method is identical to [setX](/apidocs/classes/Circle.md#setx) |
...
As [setXY](/apidocs/classes/Circle.md#setxy), but in current parent's coordinate plane (the current group if any or the canvas)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value` | `number` | y position according to object's [originY](/apidocs/classes/FabricObject.md#originy) property in parent's coordinate plane\ if parent is canvas then this property is identical to [setY](/apidocs/classes/Circle.md#sety) |
...
| Name | Type |
| :------ | :------ |
| `T` | extends `Omit`\<`Props` & [`TClassProperties`](/apidocs/modules.md#tclassproperties)\<[`Circle`](/apidocs/classes/Circle.md)\<`Props`, `SProps`, `EventSpec`\>\>, keyof `SProps`\> |
...
[src/shapes/Circle.ts:138](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L138)
...
**toggle**(`property`): [`Circle`](/apidocs/classes/Circle.md)\<`Props`, `SProps`, `EventSpec`\>
...
**fromElement**(`element`, `options?`, `cssRules?`): `Promise`\<[`Circle`](/apidocs/classes/Circle.md)\<`Partial`\<[`CircleProps`](/apidocs/interfaces/CircleProps.md)\>, [`SerializedCircleProps`](/apidocs/interfaces/SerializedCircleProps.md), [`ObjectEvents`](/apidocs/interfaces/ObjectEvents.md)\>\>

Returns [Circle](/apidocs/classes/Circle.md) instance from an SVG element
...
| `options?` | [`Abortable`](/apidocs/modules.md#abortable) | Partial Circle object to default missing properties on the element. |
| `cssRules?` | `CSSRules` | - |

#### Returns

`Promise`\<[`Circle`](/apidocs/classes/Circle.md)\<`Partial`\<[`CircleProps`](/apidocs/interfaces/CircleProps.md)\>, [`SerializedCircleProps`](/apidocs/interfaces/SerializedCircleProps.md), [`ObjectEvents`](/apidocs/interfaces/ObjectEvents.md)\>\>
...
[src/shapes/Circle.ts:204](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L204)

___

### fromObject

**fromObject**\<`T`\>(`object`): `Promise`\<[`Circle`](/apidocs/classes/Circle.md)\<`Partial`\<[`CircleProps`](/apidocs/interfaces/CircleProps.md)\>, [`SerializedCircleProps`](/apidocs/interfaces/SerializedCircleProps.md), [`ObjectEvents`](/apidocs/interfaces/ObjectEvents.md)\>\>

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends [`TOptions`](/apidocs/modules.md#toptions)\<[`SerializedCircleProps`](/apidocs/interfaces/SerializedCircleProps.md)\> |
...
[src/shapes/Circle.ts:235](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L235)
...
[src/shapes/Circle.ts:70](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Circle.ts#L70)
