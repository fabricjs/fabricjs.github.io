...
- [constructor](/apidocs/classes/filters.Noise.md#constructor)

### Properties

- [mainParameter](/apidocs/classes/filters.Noise.md#mainparameter)
- [noise](/apidocs/classes/filters.Noise.md#noise)
- [vertexSource](/apidocs/classes/filters.Noise.md#vertexsource)
- [defaults](/apidocs/classes/filters.Noise.md#defaults)
- [type](/apidocs/classes/filters.Noise.md#type)

### Accessors

- [type](/apidocs/classes/filters.Noise.md#type-1)

### Methods

- [\_setupFrameBuffer](/apidocs/classes/filters.Noise.md#_setupframebuffer)
- [\_swapTextures](/apidocs/classes/filters.Noise.md#_swaptextures)
- [applyTo](/apidocs/classes/filters.Noise.md#applyto)
- [applyTo2d](/apidocs/classes/filters.Noise.md#applyto2d)
- [applyToWebGL](/apidocs/classes/filters.Noise.md#applytowebgl)
- [bindAdditionalTexture](/apidocs/classes/filters.Noise.md#bindadditionaltexture)
- [createHelpLayer](/apidocs/classes/filters.Noise.md#createhelplayer)
- [createProgram](/apidocs/classes/filters.Noise.md#createprogram)
- [getAttributeLocations](/apidocs/classes/filters.Noise.md#getattributelocations)
- [getCacheKey](/apidocs/classes/filters.Noise.md#getcachekey)
- [getFragmentSource](/apidocs/classes/filters.Noise.md#getfragmentsource)
- [getMainParameter](/apidocs/classes/filters.Noise.md#getmainparameter)
- [getUniformLocations](/apidocs/classes/filters.Noise.md#getuniformlocations)
- [isNeutralState](/apidocs/classes/filters.Noise.md#isneutralstate)
- [retrieveShader](/apidocs/classes/filters.Noise.md#retrieveshader)
- [sendAttributeData](/apidocs/classes/filters.Noise.md#sendattributedata)
- [sendUniformData](/apidocs/classes/filters.Noise.md#senduniformdata)
- [setMainParameter](/apidocs/classes/filters.Noise.md#setmainparameter)
- [toJSON](/apidocs/classes/filters.Noise.md#tojson)
- [toObject](/apidocs/classes/filters.Noise.md#toobject)
- [unbindAdditionalTexture](/apidocs/classes/filters.Noise.md#unbindadditionaltexture)
- [fromObject](/apidocs/classes/filters.Noise.md#fromobject)
...
• `Optional` `Private` **mainParameter**: keyof [`Noise`](/apidocs/classes/filters.Noise.md)
...
[src/filters/Noise.ts:28](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Noise.ts#L28)
...
[src/filters/Noise.ts:32](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Noise.ts#L32)
...
[src/filters/Noise.ts:30](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Noise.ts#L30)
...
[src/filters/Noise.ts:44](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Noise.ts#L44)
...
[src/filters/Noise.ts:34](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Noise.ts#L34)
...
[src/filters/Noise.ts:63](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Noise.ts#L63)
...
[src/filters/Noise.ts:79](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Noise.ts#L79)
...
[src/filters/Noise.ts:91](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Noise.ts#L91)
