...
[filters](/apidocs/modules/filters.md).Gamma
...
- [constructor](/apidocs/classes/filters.Gamma.md#constructor)

### Properties

- [gamma](/apidocs/classes/filters.Gamma.md#gamma)
- [mainParameter](/apidocs/classes/filters.Gamma.md#mainparameter)
- [rgbValues](/apidocs/classes/filters.Gamma.md#rgbvalues)
- [vertexSource](/apidocs/classes/filters.Gamma.md#vertexsource)
- [defaults](/apidocs/classes/filters.Gamma.md#defaults)
- [type](/apidocs/classes/filters.Gamma.md#type)

### Accessors

- [type](/apidocs/classes/filters.Gamma.md#type-1)

### Methods

- [\_setupFrameBuffer](/apidocs/classes/filters.Gamma.md#_setupframebuffer)
- [\_swapTextures](/apidocs/classes/filters.Gamma.md#_swaptextures)
- [applyTo](/apidocs/classes/filters.Gamma.md#applyto)
- [applyTo2d](/apidocs/classes/filters.Gamma.md#applyto2d)
- [applyToWebGL](/apidocs/classes/filters.Gamma.md#applytowebgl)
- [bindAdditionalTexture](/apidocs/classes/filters.Gamma.md#bindadditionaltexture)
- [createHelpLayer](/apidocs/classes/filters.Gamma.md#createhelplayer)
- [createProgram](/apidocs/classes/filters.Gamma.md#createprogram)
- [getAttributeLocations](/apidocs/classes/filters.Gamma.md#getattributelocations)
- [getCacheKey](/apidocs/classes/filters.Gamma.md#getcachekey)
- [getFragmentSource](/apidocs/classes/filters.Gamma.md#getfragmentsource)
- [getMainParameter](/apidocs/classes/filters.Gamma.md#getmainparameter)
- [getUniformLocations](/apidocs/classes/filters.Gamma.md#getuniformlocations)
- [isNeutralState](/apidocs/classes/filters.Gamma.md#isneutralstate)
- [retrieveShader](/apidocs/classes/filters.Gamma.md#retrieveshader)
- [sendAttributeData](/apidocs/classes/filters.Gamma.md#sendattributedata)
- [sendUniformData](/apidocs/classes/filters.Gamma.md#senduniformdata)
- [setMainParameter](/apidocs/classes/filters.Gamma.md#setmainparameter)
- [toJSON](/apidocs/classes/filters.Gamma.md#tojson)
- [toObject](/apidocs/classes/filters.Gamma.md#toobject)
- [unbindAdditionalTexture](/apidocs/classes/filters.Gamma.md#unbindadditionaltexture)
- [fromObject](/apidocs/classes/filters.Gamma.md#fromobject)
...
[src/filters/Gamma.ts:43](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Gamma.ts#L43)
...
[src/filters/Gamma.ts:28](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Gamma.ts#L28)

___

### mainParameter

• `Optional` `Private` **mainParameter**: keyof [`Gamma`](/apidocs/classes/filters.Gamma.md)
...
[src/filters/Gamma.ts:29](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Gamma.ts#L29)
...
▪ `Static` **defaults**: `Partial`<[`TClassProperties`](/apidocs/modules.md#tclassproperties)<[`Gamma`](/apidocs/classes/filters.Gamma.md)\>\> = `gammaDefaultValues`
...
[src/filters/Gamma.ts:37](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Gamma.ts#L37)
...
[src/filters/Gamma.ts:35](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Gamma.ts#L35)
...
[src/filters/Gamma.ts:54](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Gamma.ts#L54)
...
[src/filters/Gamma.ts:89](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Gamma.ts#L89)
...
[src/filters/Gamma.ts:104](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Gamma.ts#L104)
