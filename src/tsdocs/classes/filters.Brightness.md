...
[filters](/apidocs/modules/filters.md).Brightness
...
- [constructor](/apidocs/classes/filters.Brightness.md#constructor)

### Properties

- [brightness](/apidocs/classes/filters.Brightness.md#brightness)
- [mainParameter](/apidocs/classes/filters.Brightness.md#mainparameter)
- [vertexSource](/apidocs/classes/filters.Brightness.md#vertexsource)
- [defaults](/apidocs/classes/filters.Brightness.md#defaults)
- [type](/apidocs/classes/filters.Brightness.md#type)

### Accessors

- [type](/apidocs/classes/filters.Brightness.md#type-1)

### Methods

- [\_setupFrameBuffer](/apidocs/classes/filters.Brightness.md#_setupframebuffer)
- [\_swapTextures](/apidocs/classes/filters.Brightness.md#_swaptextures)
- [applyTo](/apidocs/classes/filters.Brightness.md#applyto)
- [applyTo2d](/apidocs/classes/filters.Brightness.md#applyto2d)
- [applyToWebGL](/apidocs/classes/filters.Brightness.md#applytowebgl)
- [bindAdditionalTexture](/apidocs/classes/filters.Brightness.md#bindadditionaltexture)
- [createHelpLayer](/apidocs/classes/filters.Brightness.md#createhelplayer)
- [createProgram](/apidocs/classes/filters.Brightness.md#createprogram)
- [getAttributeLocations](/apidocs/classes/filters.Brightness.md#getattributelocations)
- [getCacheKey](/apidocs/classes/filters.Brightness.md#getcachekey)
- [getFragmentSource](/apidocs/classes/filters.Brightness.md#getfragmentsource)
- [getMainParameter](/apidocs/classes/filters.Brightness.md#getmainparameter)
- [getUniformLocations](/apidocs/classes/filters.Brightness.md#getuniformlocations)
- [isNeutralState](/apidocs/classes/filters.Brightness.md#isneutralstate)
- [retrieveShader](/apidocs/classes/filters.Brightness.md#retrieveshader)
- [sendAttributeData](/apidocs/classes/filters.Brightness.md#sendattributedata)
- [sendUniformData](/apidocs/classes/filters.Brightness.md#senduniformdata)
- [setMainParameter](/apidocs/classes/filters.Brightness.md#setmainparameter)
- [toJSON](/apidocs/classes/filters.Brightness.md#tojson)
- [toObject](/apidocs/classes/filters.Brightness.md#toobject)
- [unbindAdditionalTexture](/apidocs/classes/filters.Brightness.md#unbindadditionaltexture)
- [fromObject](/apidocs/classes/filters.Brightness.md#fromobject)
...
[src/filters/Brightness.ts:28](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Brightness.ts#L28)

___

### mainParameter

• `Optional` `Private` **mainParameter**: keyof [`Brightness`](/apidocs/classes/filters.Brightness.md)
...
▪ `Static` **defaults**: `Partial`<[`TClassProperties`](/apidocs/modules.md#tclassproperties)<[`Brightness`](/apidocs/classes/filters.Brightness.md)\>\> = `brightnessDefaultValues`
...
[src/filters/Brightness.ts:32](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Brightness.ts#L32)
...
[src/filters/Brightness.ts:30](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Brightness.ts#L30)
...
[src/filters/Brightness.ts:44](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Brightness.ts#L44)
...
[src/filters/Brightness.ts:34](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Brightness.ts#L34)
...
[src/filters/Brightness.ts:62](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Brightness.ts#L62)
...
[src/filters/Brightness.ts:77](https://github.com/fabricjs/fabric.js/blob/7d0e39dd9/src/filters/Brightness.ts#L77)
