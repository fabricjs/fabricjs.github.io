...
**new Path**\<`Props`, `SProps`, `EventSpec`\>(`path`, `options?`): [`Path`](/apidocs/classes/Path.md)\<`Props`, `SProps`, `EventSpec`\>
...
[src/shapes/Path.ts:77](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L77)
...
The coordinates get updated with [setCoords](/apidocs/classes/Path.md#setcoords).
You can calculate them without updating with [()](/apidocs/classes/Path.md#calcacoords)
...
[src/shapes/Path.ts:59](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L59)
...
[src/shapes/Path.ts:61](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L61)
...
[src/shapes/Path.ts:65](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L65)
...
[src/shapes/Path.ts:63](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L63)
...
[src/shapes/Path.ts:395](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L395)
...
[src/shapes/Path.ts:69](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L69)
...
[src/shapes/Path.ts:67](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L67)
...
[src/shapes/Path.ts:306](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L306)
...
[src/shapes/Path.ts:377](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L377)
...
[src/shapes/Path.ts:104](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L104)
...
[src/shapes/Path.ts:249](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L249)
...
[src/shapes/Path.ts:184](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L184)
...
[src/shapes/Path.ts:113](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L113)
...
**_set**(`key`, `value`): [`Path`](/apidocs/classes/Path.md)\<`Props`, `SProps`, `EventSpec`\>
...
**_setPath**(`path`, `adjustPosition?`): `void`
...
[src/shapes/Path.ts:93](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L93)
...
[src/shapes/Path.ts:236](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L236)
...
[src/shapes/Path.ts:290](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L290)
...
if parent is canvas then this property is identical to [getX](/apidocs/classes/Path.md#getx)
...
if parent is canvas then this property is identical to [getY](/apidocs/classes/Path.md#gety)
...
[src/shapes/Path.ts:298](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L298)
...
[src/shapes/Path.ts:294](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L294)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value` | `number` | x position according to object's [originX](/apidocs/classes/FabricObject.md#originx) property in parent's coordinate plane\ if parent is canvas then this method is identical to [setX](/apidocs/classes/Path.md#setx) |
...
As [setXY](/apidocs/classes/Path.md#setxy), but in current parent's coordinate plane (the current group if any or the canvas)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value` | `number` | y position according to object's [originY](/apidocs/classes/FabricObject.md#originy) property in parent's coordinate plane\ if parent is canvas then this property is identical to [setY](/apidocs/classes/Path.md#sety) |
...
[src/shapes/Path.ts:262](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L262)
...
[src/shapes/Path.ts:219](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L219)
...
[src/shapes/Path.ts:204](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L204)
...
[src/shapes/Path.ts:278](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L278)
...
[src/shapes/Path.ts:193](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L193)
...
**fromElement**(`element`, `options?`, `cssRules?`): `Promise`\<[`Path`](/apidocs/classes/Path.md)\<\{ `absolutePositioned`: `boolean` ; `activeOn`: ``"down"`` \| ``"up"`` ; `angle`: [`TDegree`](/apidocs/modules.md#tdegree) ; `backgroundColor`: `string` ; `borderColor`: `string` ; `borderDashArray`: ``null`` \| `number`[] ; `borderOpacityWhenMoving`: `number` ; `borderScaleFactor`: `number` ; `canvas`: [`Canvas`](/apidocs/classes/Canvas.md) \| [`StaticCanvas`](/apidocs/classes/StaticCanvas.md)\<[`StaticCanvasEvents`](/apidocs/interfaces/StaticCanvasEvents.md)\> ; `centeredRotation`: `boolean` ; `centeredScaling`: `boolean` ; `clipPath`: `FabricObject`\<`Partial`\<`ObjectProps`\>, [`SerializedObjectProps`](/apidocs/interfaces/SerializedObjectProps.md), [`ObjectEvents`](/apidocs/interfaces/ObjectEvents.md)\> ; `cornerColor`: `string` ; `cornerDashArray`: ``null`` \| `number`[] ; `cornerSize`: `number` ; `cornerStrokeColor`: `string` ; `cornerStyle`: ``"circle"`` \| ``"rect"`` ; `evented`: `boolean` ; `excludeFromExport`: `boolean` ; `fill`: ``null`` \| `string` \| [`Pattern`](/apidocs/classes/Pattern.md) \| [`Gradient`](/apidocs/classes/Gradient.md)\<``"linear"``, ``"linear"``\> \| [`Gradient`](/apidocs/classes/Gradient.md)\<``"radial"``, ``"radial"``\> ; `fillRule`: ``"evenodd"`` \| ``"nonzero"`` ; `flipX`: `boolean` ; `flipY`: `boolean` ; `globalCompositeOperation`: ``"screen"`` \| ``"color"`` \| ``"color-burn"`` \| ``"color-dodge"`` \| ``"copy"`` \| ``"darken"`` \| ``"destination-atop"`` \| ``"destination-in"`` \| ``"destination-out"`` \| ``"destination-over"`` \| ``"difference"`` \| ``"exclusion"`` \| ``"hard-light"`` \| ``"hue"`` \| ``"lighten"`` \| ``"lighter"`` \| ``"luminosity"`` \| ``"multiply"`` \| ``"overlay"`` \| ``"saturation"`` \| ``"soft-light"`` \| ``"source-atop"`` \| ``"source-in"`` \| ``"source-out"`` \| ``"source-over"`` \| ``"xor"`` ; `hasBorders`: `boolean` ; `hasControls`: `boolean` ; `height`: `number` ; `hoverCursor`: ``null`` \| `string` ; `includeDefaultValues`: `boolean` ; `inverted`: `boolean` ; `left`: `undefined` = undefined; `lockMovementX`: `boolean` ; `lockMovementY`: `boolean` ; `lockRotation`: `boolean` ; `lockScalingFlip`: `boolean` ; `lockScalingX`: `boolean` ; `lockScalingY`: `boolean` ; `lockSkewingX`: `boolean` ; `lockSkewingY`: `boolean` ; `minScaleLimit`: `number` ; `moveCursor`: ``null`` \| `string` ; `noScaleCache`: `boolean` ; `objectCaching`: `boolean` ; `opacity`: `number` ; `originX`: `number` \| ``"center"`` \| ``"left"`` \| ``"right"`` ; `originY`: `number` \| ``"center"`` \| ``"top"`` \| ``"bottom"`` ; `padding`: `number` ; `paintFirst`: ``"fill"`` \| ``"stroke"`` ; `path`: [`TSimplePathData`](/apidocs/modules/util.md#tsimplepathdata) ; `perPixelTargetFind`: `boolean` ; `scaleX`: `number` ; `scaleY`: `number` ; `selectable`: `boolean` ; `selectionBackgroundColor`: `string` ; `shadow`: ``null`` \| [`Shadow`](/apidocs/classes/Shadow.md) ; `skewX`: [`TDegree`](/apidocs/modules.md#tdegree) ; `skewY`: [`TDegree`](/apidocs/modules.md#tdegree) ; `snapAngle`: [`TDegree`](/apidocs/modules.md#tdegree) ; `snapThreshold`: [`TDegree`](/apidocs/modules.md#tdegree) ; `sourcePath`: `string` ; `stroke`: ``null`` \| `string` \| [`Pattern`](/apidocs/classes/Pattern.md) \| [`Gradient`](/apidocs/classes/Gradient.md)\<``"linear"``, ``"linear"``\> \| [`Gradient`](/apidocs/classes/Gradient.md)\<``"radial"``, ``"radial"``\> ; `strokeDashArray`: ``null`` \| `number`[] ; `strokeDashOffset`: `number` ; `strokeLineCap`: ``"butt"`` \| ``"round"`` \| ``"square"`` ; `strokeLineJoin`: ``"round"`` \| ``"bevel"`` \| ``"miter"`` ; `strokeMiterLimit`: `number` ; `strokeUniform`: `boolean` ; `strokeWidth`: `number` ; `top`: `undefined` = undefined; `touchCornerSize`: `number` ; `transparentCorners`: `boolean` ; `visible`: `boolean` ; `width`: `number`  }, [`SerializedPathProps`](/apidocs/interfaces/SerializedPathProps.md), [`ObjectEvents`](/apidocs/interfaces/ObjectEvents.md)\>\>
...
`Promise`\<[`Path`](/apidocs/classes/Path.md)\<\{ `absolutePositioned`: `boolean` ; `activeOn`: ``"down"`` \| ``"up"`` ; `angle`: [`TDegree`](/apidocs/modules.md#tdegree) ; `backgroundColor`: `string` ; `borderColor`: `string` ; `borderDashArray`: ``null`` \| `number`[] ; `borderOpacityWhenMoving`: `number` ; `borderScaleFactor`: `number` ; `canvas`: [`Canvas`](/apidocs/classes/Canvas.md) \| [`StaticCanvas`](/apidocs/classes/StaticCanvas.md)\<[`StaticCanvasEvents`](/apidocs/interfaces/StaticCanvasEvents.md)\> ; `centeredRotation`: `boolean` ; `centeredScaling`: `boolean` ; `clipPath`: `FabricObject`\<`Partial`\<`ObjectProps`\>, [`SerializedObjectProps`](/apidocs/interfaces/SerializedObjectProps.md), [`ObjectEvents`](/apidocs/interfaces/ObjectEvents.md)\> ; `cornerColor`: `string` ; `cornerDashArray`: ``null`` \| `number`[] ; `cornerSize`: `number` ; `cornerStrokeColor`: `string` ; `cornerStyle`: ``"circle"`` \| ``"rect"`` ; `evented`: `boolean` ; `excludeFromExport`: `boolean` ; `fill`: ``null`` \| `string` \| [`Pattern`](/apidocs/classes/Pattern.md) \| [`Gradient`](/apidocs/classes/Gradient.md)\<``"linear"``, ``"linear"``\> \| [`Gradient`](/apidocs/classes/Gradient.md)\<``"radial"``, ``"radial"``\> ; `fillRule`: ``"evenodd"`` \| ``"nonzero"`` ; `flipX`: `boolean` ; `flipY`: `boolean` ; `globalCompositeOperation`: ``"screen"`` \| ``"color"`` \| ``"color-burn"`` \| ``"color-dodge"`` \| ``"copy"`` \| ``"darken"`` \| ``"destination-atop"`` \| ``"destination-in"`` \| ``"destination-out"`` \| ``"destination-over"`` \| ``"difference"`` \| ``"exclusion"`` \| ``"hard-light"`` \| ``"hue"`` \| ``"lighten"`` \| ``"lighter"`` \| ``"luminosity"`` \| ``"multiply"`` \| ``"overlay"`` \| ``"saturation"`` \| ``"soft-light"`` \| ``"source-atop"`` \| ``"source-in"`` \| ``"source-out"`` \| ``"source-over"`` \| ``"xor"`` ; `hasBorders`: `boolean` ; `hasControls`: `boolean` ; `height`: `number` ; `hoverCursor`: ``null`` \| `string` ; `includeDefaultValues`: `boolean` ; `inverted`: `boolean` ; `left`: `undefined` = undefined; `lockMovementX`: `boolean` ; `lockMovementY`: `boolean` ; `lockRotation`: `boolean` ; `lockScalingFlip`: `boolean` ; `lockScalingX`: `boolean` ; `lockScalingY`: `boolean` ; `lockSkewingX`: `boolean` ; `lockSkewingY`: `boolean` ; `minScaleLimit`: `number` ; `moveCursor`: ``null`` \| `string` ; `noScaleCache`: `boolean` ; `objectCaching`: `boolean` ; `opacity`: `number` ; `originX`: `number` \| ``"center"`` \| ``"left"`` \| ``"right"`` ; `originY`: `number` \| ``"center"`` \| ``"top"`` \| ``"bottom"`` ; `padding`: `number` ; `paintFirst`: ``"fill"`` \| ``"stroke"`` ; `path`: [`TSimplePathData`](/apidocs/modules/util.md#tsimplepathdata) ; `perPixelTargetFind`: `boolean` ; `scaleX`: `number` ; `scaleY`: `number` ; `selectable`: `boolean` ; `selectionBackgroundColor`: `string` ; `shadow`: ``null`` \| [`Shadow`](/apidocs/classes/Shadow.md) ; `skewX`: [`TDegree`](/apidocs/modules.md#tdegree) ; `skewY`: [`TDegree`](/apidocs/modules.md#tdegree) ; `snapAngle`: [`TDegree`](/apidocs/modules.md#tdegree) ; `snapThreshold`: [`TDegree`](/apidocs/modules.md#tdegree) ; `sourcePath`: `string` ; `stroke`: ``null`` \| `string` \| [`Pattern`](/apidocs/classes/Pattern.md) \| [`Gradient`](/apidocs/classes/Gradient.md)\<``"linear"``, ``"linear"``\> \| [`Gradient`](/apidocs/classes/Gradient.md)\<``"radial"``, ``"radial"``\> ; `strokeDashArray`: ``null`` \| `number`[] ; `strokeDashOffset`: `number` ; `strokeLineCap`: ``"butt"`` \| ``"round"`` \| ``"square"`` ; `strokeLineJoin`: ``"round"`` \| ``"bevel"`` \| ``"miter"`` ; `strokeMiterLimit`: `number` ; `strokeUniform`: `boolean` ; `strokeWidth`: `number` ; `top`: `undefined` = undefined; `touchCornerSize`: `number` ; `transparentCorners`: `boolean` ; `visible`: `boolean` ; `width`: `number`  }, [`SerializedPathProps`](/apidocs/interfaces/SerializedPathProps.md), [`ObjectEvents`](/apidocs/interfaces/ObjectEvents.md)\>\>
...
[src/shapes/Path.ts:417](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L417)

___

### fromObject

**fromObject**\<`T`\>(`object`): `Promise`\<[`Path`](/apidocs/classes/Path.md)\<`Partial`\<[`PathProps`](/apidocs/interfaces/PathProps.md)\>, [`SerializedPathProps`](/apidocs/interfaces/SerializedPathProps.md), [`ObjectEvents`](/apidocs/interfaces/ObjectEvents.md)\>\>
...
[src/shapes/Path.ts:404](https://github.com/fabricjs/fabric.js/blob/b24e8cbdf/src/shapes/Path.ts#L404)
