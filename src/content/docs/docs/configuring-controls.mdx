...
<CodeEditor code={code1} canvasId="c" client:idle runOnChange={false} canvasDown >
...
<CodeEditor code={code2} canvasId="d" client:idle runOnChange={false} canvasDown >
...
<CodeEditor code={code3} canvasId="e" client:idle runOnChange={false} canvasDown >
...
<CodeEditor code={code4} canvasId="f" client:idle runOnChange={false} canvasDown >
...
<CodeEditor code={code5} canvasId="g" client:idle runOnChange={false} canvasDown >
