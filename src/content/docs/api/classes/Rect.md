...
Defined in: [src/shapes/Rect.ts:29](https://github.com/fabricjs/fabric.js/blob/8748628df7e9de00ba77413bfc3ad9e9fe9d4f30/src/shapes/Rect.ts#L29)
...
Defined in: [src/shapes/Rect.ts:68](https://github.com/fabricjs/fabric.js/blob/8748628df7e9de00ba77413bfc3ad9e9fe9d4f30/src/shapes/Rect.ts#L68)
...
Defined in: [src/shapes/Rect.ts:42](https://github.com/fabricjs/fabric.js/blob/8748628df7e9de00ba77413bfc3ad9e9fe9d4f30/src/shapes/Rect.ts#L42)
...
Defined in: [src/shapes/Rect.ts:49](https://github.com/fabricjs/fabric.js/blob/8748628df7e9de00ba77413bfc3ad9e9fe9d4f30/src/shapes/Rect.ts#L49)
...
Defined in: [src/shapes/Rect.ts:179](https://github.com/fabricjs/fabric.js/blob/8748628df7e9de00ba77413bfc3ad9e9fe9d4f30/src/shapes/Rect.ts#L179)
...
Defined in: [src/shapes/Rect.ts:53](https://github.com/fabricjs/fabric.js/blob/8748628df7e9de00ba77413bfc3ad9e9fe9d4f30/src/shapes/Rect.ts#L53)
...
> `static` **ownDefaults**: `Partial`\<[`TClassProperties`](/api/type-aliases/tclassproperties/)\<[`Rect`](/api/classes/rect/)\>\> = `rectDefaultValues`

Defined in: [src/shapes/Rect.ts:55](https://github.com/fabricjs/fabric.js/blob/8748628df7e9de00ba77413bfc3ad9e9fe9d4f30/src/shapes/Rect.ts#L55)
...
Defined in: [src/shapes/Rect.ts:51](https://github.com/fabricjs/fabric.js/blob/8748628df7e9de00ba77413bfc3ad9e9fe9d4f30/src/shapes/Rect.ts#L51)
...
`Pick`\<[`Rect`](/api/classes/rect/)\<`Props`, `SProps`, `EventSpec`\>, `"fill"`\>
...
`Pick`\<[`Rect`](/api/classes/rect/)\<`Props`, `SProps`, `EventSpec`\>, `"stroke"` \| `"strokeWidth"` \| `"strokeDashOffset"` \| `"strokeLineCap"` \| `"strokeLineJoin"` \| `"strokeMiterLimit"`\>
...
Defined in: [src/shapes/Rect.ts:162](https://github.com/fabricjs/fabric.js/blob/8748628df7e9de00ba77413bfc3ad9e9fe9d4f30/src/shapes/Rect.ts#L162)
...
Defined in: [src/shapes/Rect.ts:150](https://github.com/fabricjs/fabric.js/blob/8748628df7e9de00ba77413bfc3ad9e9fe9d4f30/src/shapes/Rect.ts#L150)
...
> `static` **fromElement**(`element`, `options`?, `cssRules`?): `Promise`\<[`Rect`](/api/classes/rect/)\<\{ `height`: `any`; `left`: `any`; `signal`: `AbortSignal`; `top`: `any`; `visible`: `boolean`; `width`: `any`; \}\>\>

Defined in: [src/shapes/Rect.ts:198](https://github.com/fabricjs/fabric.js/blob/8748628df7e9de00ba77413bfc3ad9e9fe9d4f30/src/shapes/Rect.ts#L198)
...
`Promise`\<[`Rect`](/api/classes/rect/)\<\{ `height`: `any`; `left`: `any`; `signal`: `AbortSignal`; `top`: `any`; `visible`: `boolean`; `width`: `any`; \}\>\>
...
Defined in: [src/shapes/Rect.ts:57](https://github.com/fabricjs/fabric.js/blob/8748628df7e9de00ba77413bfc3ad9e9fe9d4f30/src/shapes/Rect.ts#L57)
