# Class: Image<Props, SProps, EventSpec\>
...
| Name | Type |
| :------ | :------ |
| `Props` | extends [`TOptions`](../modules.md#toptions)<[`ImageProps`](../interfaces/ImageProps.md)\> = `Partial`<[`ImageProps`](../interfaces/ImageProps.md)\> |
...
- [\_\_corner](Image.md#__corner)
- [\_\_owningGroup](Image.md#__owninggroup)
- [\_cacheCanvas](Image.md#_cachecanvas)
- [\_cacheContext](Image.md#_cachecontext)
- [\_controlsVisibility](Image.md#_controlsvisibility)
- [\_element](Image.md#_element)
- [\_filterScalingX](Image.md#_filterscalingx)
- [\_filterScalingY](Image.md#_filterscalingy)
- [\_filteredEl](Image.md#_filteredel)
- [\_lastScaleX](Image.md#_lastscalex)
- [\_lastScaleY](Image.md#_lastscaley)
- [\_originalElement](Image.md#_originalelement)
- [\_originalOriginX](Image.md#_originaloriginx)
- [\_originalOriginY](Image.md#_originaloriginy)
- [\_scaling](Image.md#_scaling)
- [\_transformDone](Image.md#_transformdone)
- [aCoords](Image.md#acoords)
- [absolutePositioned](Image.md#absolutepositioned)
- [activeOn](Image.md#activeon)
- [angle](Image.md#angle)
- [backgroundColor](Image.md#backgroundcolor)
- [borderColor](Image.md#bordercolor)
- [borderDashArray](Image.md#borderdasharray)
- [borderOpacityWhenMoving](Image.md#borderopacitywhenmoving)
- [borderScaleFactor](Image.md#borderscalefactor)
- [cacheHeight](Image.md#cacheheight)
- [cacheKey](Image.md#cachekey)
- [cacheTranslationX](Image.md#cachetranslationx)
- [cacheTranslationY](Image.md#cachetranslationy)
- [cacheWidth](Image.md#cachewidth)
- [canvas](Image.md#canvas)
- [centeredRotation](Image.md#centeredrotation)
- [centeredScaling](Image.md#centeredscaling)
- [clipPath](Image.md#clippath)
- [clipPathId](Image.md#clippathid)
- [colorProperties](Image.md#colorproperties)
- [controls](Image.md#controls)
- [cornerColor](Image.md#cornercolor)
- [cornerDashArray](Image.md#cornerdasharray)
- [cornerSize](Image.md#cornersize)
- [cornerStrokeColor](Image.md#cornerstrokecolor)
- [cornerStyle](Image.md#cornerstyle)
- [cropX](Image.md#cropx)
- [cropY](Image.md#cropy)
- [dirty](Image.md#dirty)
- [evented](Image.md#evented)
- [excludeFromExport](Image.md#excludefromexport)
- [fill](Image.md#fill)
- [fillRule](Image.md#fillrule)
- [filters](Image.md#filters)
- [flipX](Image.md#flipx)
- [flipY](Image.md#flipy)
- [globalCompositeOperation](Image.md#globalcompositeoperation)
- [group](Image.md#group)
- [hasBorders](Image.md#hasborders)
- [hasControls](Image.md#hascontrols)
- [height](Image.md#height)
- [hoverCursor](Image.md#hovercursor)
- [imageSmoothing](Image.md#imagesmoothing)
- [includeDefaultValues](Image.md#includedefaultvalues)
- [inverted](Image.md#inverted)
- [isMoving](Image.md#ismoving)
- [left](Image.md#left)
- [lineCoords](Image.md#linecoords)
- [lockMovementX](Image.md#lockmovementx)
- [lockMovementY](Image.md#lockmovementy)
- [lockRotation](Image.md#lockrotation)
- [lockScalingFlip](Image.md#lockscalingflip)
- [lockScalingX](Image.md#lockscalingx)
- [lockScalingY](Image.md#lockscalingy)
- [lockSkewingX](Image.md#lockskewingx)
- [lockSkewingY](Image.md#lockskewingy)
- [matrixCache](Image.md#matrixcache)
- [minScaleLimit](Image.md#minscalelimit)
- [minimumScaleTrigger](Image.md#minimumscaletrigger)
- [moveCursor](Image.md#movecursor)
- [noScaleCache](Image.md#noscalecache)
- [oCoords](Image.md#ocoords)
- [objectCaching](Image.md#objectcaching)
- [opacity](Image.md#opacity)
- [originX](Image.md#originx)
- [originY](Image.md#originy)
- [ownCaching](Image.md#owncaching)
- [ownMatrixCache](Image.md#ownmatrixcache)
- [padding](Image.md#padding)
- [paintFirst](Image.md#paintfirst)
- [perPixelTargetFind](Image.md#perpixeltargetfind)
- [preserveAspectRatio](Image.md#preserveaspectratio)
- [resizeFilter](Image.md#resizefilter)
- [scaleX](Image.md#scalex)
- [scaleY](Image.md#scaley)
- [selectable](Image.md#selectable)
- [selectionBackgroundColor](Image.md#selectionbackgroundcolor)
- [shadow](Image.md#shadow)
- [skewX](Image.md#skewx)
- [skewY](Image.md#skewy)
- [snapAngle](Image.md#snapangle)
- [snapThreshold](Image.md#snapthreshold)
- [src](Image.md#src)
- [srcFromAttribute](Image.md#srcfromattribute)
- [stroke](Image.md#stroke)
- [strokeDashArray](Image.md#strokedasharray)
- [strokeDashOffset](Image.md#strokedashoffset)
- [strokeLineCap](Image.md#strokelinecap)
- [strokeLineJoin](Image.md#strokelinejoin)
- [strokeMiterLimit](Image.md#strokemiterlimit)
- [strokeUniform](Image.md#strokeuniform)
- [strokeWidth](Image.md#strokewidth)
- [top](Image.md#top)
- [touchCornerSize](Image.md#touchcornersize)
- [transparentCorners](Image.md#transparentcorners)
- [visible](Image.md#visible)
- [width](Image.md#width)
- [zoomX](Image.md#zoomx)
- [zoomY](Image.md#zoomy)
- [ATTRIBUTE\_NAMES](Image.md#attribute_names)
- [CSS\_CANVAS](Image.md#css_canvas)
- [cacheProperties](Image.md#cacheproperties)
- [ownDefaults](Image.md#owndefaults)
- [stateProperties](Image.md#stateproperties)
- [type](Image.md#type)

### Accessors

- [type](Image.md#type-1)

### Methods

- [\_animate](Image.md#_animate)
- [\_applyPatternForTransformedGradient](Image.md#_applypatternfortransformedgradient)
- [\_applyPatternGradientTransform](Image.md#_applypatterngradienttransform)
- [\_calculateCurrentDimensions](Image.md#_calculatecurrentdimensions)
- [\_constrainScale](Image.md#_constrainscale)
- [\_createBaseClipPathSVGMarkup](Image.md#_createbaseclippathsvgmarkup)
- [\_createBaseSVGMarkup](Image.md#_createbasesvgmarkup)
- [\_createCacheCanvas](Image.md#_createcachecanvas)
- [\_drawBorders](Image.md#_drawborders)
- [\_drawClipPath](Image.md#_drawclippath)
- [\_findCenterFromElement](Image.md#_findcenterfromelement)
- [\_findCrossPoints](Image.md#_findcrosspoints)
- [\_findTargetCorner](Image.md#_findtargetcorner)
- [\_getCacheCanvasDimensions](Image.md#_getcachecanvasdimensions)
- [\_getCoords](Image.md#_getcoords)
- [\_getImageLines](Image.md#_getimagelines)
- [\_getLeftTopCoords](Image.md#_getlefttopcoords)
- [\_getNonTransformedDimensions](Image.md#_getnontransformeddimensions)
- [\_getTransformedDimensions](Image.md#_gettransformeddimensions)
- [\_limitCacheSize](Image.md#_limitcachesize)
- [\_needsResize](Image.md#_needsresize)
- [\_removeCacheCanvas](Image.md#_removecachecanvas)
- [\_removeDefaultValues](Image.md#_removedefaultvalues)
- [\_removeShadow](Image.md#_removeshadow)
- [\_render](Image.md#_render)
- [\_renderBackground](Image.md#_renderbackground)
- [\_renderControls](Image.md#_rendercontrols)
- [\_renderFill](Image.md#_renderfill)
- [\_renderPaintInOrder](Image.md#_renderpaintinorder)
- [\_renderStroke](Image.md#_renderstroke)
- [\_resetOrigin](Image.md#_resetorigin)
- [\_resetWidthHeight](Image.md#_resetwidthheight)
- [\_set](Image.md#_set)
- [\_setClippingProperties](Image.md#_setclippingproperties)
- [\_setFillStyles](Image.md#_setfillstyles)
- [\_setLineDash](Image.md#_setlinedash)
- [\_setObject](Image.md#_setobject)
- [\_setOpacity](Image.md#_setopacity)
- [\_setOptions](Image.md#_setoptions)
- [\_setOriginToCenter](Image.md#_setorigintocenter)
- [\_setShadow](Image.md#_setshadow)
- [\_setStrokeStyles](Image.md#_setstrokestyles)
- [\_setWidthHeight](Image.md#_setwidthheight)
- [\_setupCompositeOperation](Image.md#_setupcompositeoperation)
- [\_stroke](Image.md#_stroke)
- [\_toSVG](Image.md#_tosvg)
- [\_updateCacheCanvas](Image.md#_updatecachecanvas)
- [addPaintOrder](Image.md#addpaintorder)
- [animate](Image.md#animate)
- [applyFilters](Image.md#applyfilters)
- [applyResizeFilters](Image.md#applyresizefilters)
- [calcACoords](Image.md#calcacoords)
- [calcLineCoords](Image.md#calclinecoords)
- [calcOCoords](Image.md#calcocoords)
- [calcOwnMatrix](Image.md#calcownmatrix)
- [calcTransformMatrix](Image.md#calctransformmatrix)
- [canDrop](Image.md#candrop)
- [clearContextTop](Image.md#clearcontexttop)
- [clone](Image.md#clone)
- [cloneAsImage](Image.md#cloneasimage)
- [complexity](Image.md#complexity)
- [containsPoint](Image.md#containspoint)
- [dispose](Image.md#dispose)
- [drawBorders](Image.md#drawborders)
- [drawCacheOnCanvas](Image.md#drawcacheoncanvas)
- [drawClipPathOnCache](Image.md#drawclippathoncache)
- [drawControls](Image.md#drawcontrols)
- [drawControlsConnectingLines](Image.md#drawcontrolsconnectinglines)
- [drawObject](Image.md#drawobject)
- [drawSelectionBackground](Image.md#drawselectionbackground)
- [findCommonAncestors](Image.md#findcommonancestors)
- [fire](Image.md#fire)
- [forEachControl](Image.md#foreachcontrol)
- [get](Image.md#get)
- [getActiveControl](Image.md#getactivecontrol)
- [getAncestors](Image.md#getancestors)
- [getBoundingRect](Image.md#getboundingrect)
- [getCanvasRetinaScaling](Image.md#getcanvasretinascaling)
- [getCenterPoint](Image.md#getcenterpoint)
- [getCoords](Image.md#getcoords)
- [getCrossOrigin](Image.md#getcrossorigin)
- [getElement](Image.md#getelement)
- [getObjectOpacity](Image.md#getobjectopacity)
- [getObjectScaling](Image.md#getobjectscaling)
- [getOriginalSize](Image.md#getoriginalsize)
- [getParent](Image.md#getparent)
- [getPointByOrigin](Image.md#getpointbyorigin)
- [getRelativeCenterPoint](Image.md#getrelativecenterpoint)
- [getRelativeX](Image.md#getrelativex)
- [getRelativeXY](Image.md#getrelativexy)
- [getRelativeY](Image.md#getrelativey)
- [getScaledHeight](Image.md#getscaledheight)
- [getScaledWidth](Image.md#getscaledwidth)
- [getSrc](Image.md#getsrc)
- [getSvgCommons](Image.md#getsvgcommons)
- [getSvgFilter](Image.md#getsvgfilter)
- [getSvgSrc](Image.md#getsvgsrc)
- [getSvgStyles](Image.md#getsvgstyles)
- [getSvgTransform](Image.md#getsvgtransform)
- [getTotalAngle](Image.md#gettotalangle)
- [getTotalObjectScaling](Image.md#gettotalobjectscaling)
- [getViewportTransform](Image.md#getviewporttransform)
- [getX](Image.md#getx)
- [getXY](Image.md#getxy)
- [getY](Image.md#gety)
- [hasCommonAncestors](Image.md#hascommonancestors)
- [hasCrop](Image.md#hascrop)
- [hasFill](Image.md#hasfill)
- [hasStroke](Image.md#hasstroke)
- [intersectsWithObject](Image.md#intersectswithobject)
- [intersectsWithRect](Image.md#intersectswithrect)
- [isCacheDirty](Image.md#iscachedirty)
- [isContainedWithinObject](Image.md#iscontainedwithinobject)
- [isContainedWithinRect](Image.md#iscontainedwithinrect)
- [isControlVisible](Image.md#iscontrolvisible)
- [isDescendantOf](Image.md#isdescendantof)
- [isInFrontOf](Image.md#isinfrontof)
- [isNotVisible](Image.md#isnotvisible)
- [isOnScreen](Image.md#isonscreen)
- [isOverlapping](Image.md#isoverlapping)
- [isPartiallyOnScreen](Image.md#ispartiallyonscreen)
- [isType](Image.md#istype)
- [needsItsOwnCache](Image.md#needsitsowncache)
- [off](Image.md#off)
- [on](Image.md#on)
- [onDeselect](Image.md#ondeselect)
- [onSelect](Image.md#onselect)
- [once](Image.md#once)
- [parsePreserveAspectRatioAttribute](Image.md#parsepreserveaspectratioattribute)
- [removeTexture](Image.md#removetexture)
- [render](Image.md#render)
- [renderCache](Image.md#rendercache)
- [renderDragSourceEffect](Image.md#renderdragsourceeffect)
- [renderDropTargetEffect](Image.md#renderdroptargeteffect)
- [rotate](Image.md#rotate)
- [scale](Image.md#scale)
- [scaleToHeight](Image.md#scaletoheight)
- [scaleToWidth](Image.md#scaletowidth)
- [set](Image.md#set)
- [setControlVisible](Image.md#setcontrolvisible)
- [setControlsVisibility](Image.md#setcontrolsvisibility)
- [setCoords](Image.md#setcoords)
- [setElement](Image.md#setelement)
- [setOnGroup](Image.md#setongroup)
- [setOptions](Image.md#setoptions)
- [setPositionByOrigin](Image.md#setpositionbyorigin)
- [setRelativeX](Image.md#setrelativex)
- [setRelativeXY](Image.md#setrelativexy)
- [setRelativeY](Image.md#setrelativey)
- [setSrc](Image.md#setsrc)
- [setX](Image.md#setx)
- [setXY](Image.md#setxy)
- [setY](Image.md#sety)
- [shouldCache](Image.md#shouldcache)
- [strokeBorders](Image.md#strokeborders)
- [toCanvasElement](Image.md#tocanvaselement)
- [toClipPathSVG](Image.md#toclippathsvg)
- [toDataURL](Image.md#todataurl)
- [toDatalessObject](Image.md#todatalessobject)
- [toJSON](Image.md#tojson)
- [toObject](Image.md#toobject)
- [toSVG](Image.md#tosvg)
- [toString](Image.md#tostring)
- [toggle](Image.md#toggle)
- [transform](Image.md#transform)
- [transformMatrixKey](Image.md#transformmatrixkey)
- [translateToCenterPoint](Image.md#translatetocenterpoint)
- [translateToGivenOrigin](Image.md#translatetogivenorigin)
- [translateToOriginPoint](Image.md#translatetooriginpoint)
- [willDrawShadow](Image.md#willdrawshadow)
- [\_fromObject](Image.md#_fromobject)
- [fromElement](Image.md#fromelement)
- [fromObject](Image.md#fromobject)
- [fromURL](Image.md#fromurl)
- [getDefaults](Image.md#getdefaults)

## Constructors

### constructor

• **new Image**<`Props`, `SProps`, `EventSpec`\>(`elementId`, `options?`)
...
[src/shapes/Image.ts:197](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L197)

• **new Image**<`Props`, `SProps`, `EventSpec`\>(`element`, `options?`)
...
| Name | Type |
| :------ | :------ |
| `element` | [`ImageSource`](../modules.md#imagesource) |
| `options?` | `Props` |
...
[src/shapes/Image.ts:198](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L198)
...
• **\_element**: [`ImageSource`](../modules.md#imagesource)

#### Defined in

[src/shapes/Image.ts:172](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L172)
...
[src/shapes/Image.ts:115](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L115)
...
[src/shapes/Image.ts:122](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L122)
...
[src/shapes/Image.ts:173](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L173)
...
[src/shapes/Image.ts:100](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L100)
...
[src/shapes/Image.ts:108](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L108)

___

### \_originalElement

• **\_originalElement**: [`ImageSource`](../modules.md#imagesource)

#### Defined in

[src/shapes/Image.ts:174](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L174)
...
[ImageProps](../interfaces/ImageProps.md).[activeOn](../interfaces/ImageProps.md#activeon)
...
[src/shapes/Image.ts:138](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L138)
...
[src/shapes/Image.ts:146](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L146)
...
[src/shapes/Image.ts:154](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L154)
...
• **filters**: [`BaseFilter`](filters.BaseFilter.md)[]
...
[src/shapes/Image.ts:169](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L169)
...
[src/shapes/Image.ts:163](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L163)
...
[src/shapes/Image.ts:130](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L130)
...
[src/shapes/Image.ts:165](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L165)

___

### resizeFilter

• **resizeFilter**: [`Resize`](filters.Resize.md)
...
[src/shapes/Image.ts:170](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L170)
...
[src/shapes/Image.ts:167](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L167)
...
When calling [getSrc](Image.md#getsrc), return value from element src with `element.getAttribute('src')`.
...
[src/shapes/Image.ts:92](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L92)
...
List of attribute names to account for when parsing SVG element (used by [fromElement](Image.md#fromelement))
...
[src/shapes/Image.ts:771](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L771)
...
[src/shapes/Image.ts:764](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L764)
...
[src/shapes/Image.ts:178](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L178)
...
[src/shapes/Image.ts:180](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L180)
...
[src/shapes/Image.ts:176](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L176)
...
[src/shapes/Image.ts:659](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L659)
...
[src/shapes/Image.ts:586](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L586)
...
[src/shapes/Image.ts:624](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L624)
...
[src/shapes/Image.ts:668](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L668)

___

### \_set

▸ `Protected` **_set**(`key`, `value`): [`Image`](Image.md)<`Props`, `SProps`, `EventSpec`\>
...
[`Image`](Image.md)<`Props`, `SProps`, `EventSpec`\>
...
| :------ | :------ |
| `ctx` | `CanvasRenderingContext2D` |
| `«destructured»` | `Pick`<[`Image`](Image.md)<`Props`, `SProps`, `EventSpec`\>, ``"fill"``\> |
...
| :------ | :------ |
| `ctx` | `CanvasRenderingContext2D` |
| `decl` | `Pick`<[`Image`](Image.md)<`Props`, `SProps`, `EventSpec`\>, ``"strokeDashOffset"`` \| ``"strokeLineCap"`` \| ``"strokeLineJoin"`` \| ``"strokeMiterLimit"`` \| ``"strokeWidth"`` \| ``"stroke"``\> |
...
| Name | Type |
| :------ | :------ |
| `«destructured»` | `Partial`<[`TSize`](../modules.md#tsize)\> |
...
[src/shapes/Image.ts:677](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L677)
...
[src/shapes/Image.ts:305](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L305)
...
[src/shapes/Image.ts:362](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L362)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `filters` | [`BaseFilter`](filters.BaseFilter.md)[] | to be applied |
...
[src/shapes/Image.ts:522](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L522)
...
[src/shapes/Image.ts:479](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L479)
...
▸ **clone**(`propertiesToInclude?`): `Promise`<[`Image`](Image.md)<`Props`, `SProps`, `EventSpec`\>\>
...
`Promise`<[`Image`](Image.md)<`Props`, `SProps`, `EventSpec`\>\>
...
[src/shapes/Object/Object.ts:1476](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Object/Object.ts#L1476)
...
[src/shapes/Image.ts:259](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L259)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `this` | `TCachedFabricObject`<[`Image`](Image.md)<`Partial`<[`ImageProps`](../interfaces/ImageProps.md)\>, [`SerializedImageProps`](../interfaces/SerializedImageProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\> | - |
| `ctx` | `CanvasRenderingContext2D` | Context to render on |
...
[src/shapes/Image.ts:600](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L600)
...
| Name | Type |
| :------ | :------ |
| `T` | extends [`Image`](Image.md)<`Props`, `SProps`, `EventSpec`, `T`\> |
| `S` | extends `boolean` |
...
[src/shapes/Image.ts:277](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L277)

___

### getElement

▸ **getElement**(): [`ImageSource`](../modules.md#imagesource)
...
[src/shapes/Image.ts:216](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L216)
...
[src/shapes/Image.ts:287](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L287)
...
[src/shapes/Image.ts:432](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L432)
...
[src/shapes/Image.ts:454](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L454)
...
[src/shapes/Image.ts:348](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L348)
...
[src/shapes/Image.ts:688](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L688)
...
[src/shapes/Image.ts:249](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L249)
...
▸ **set**(`key`, `value?`): [`Image`](Image.md)<`Props`, `SProps`, `EventSpec`\>
...
| :------ | :------ | :------ |
| `element` | [`ImageSource`](../modules.md#imagesource) |  |
| `size?` | `Partial`<[`TSize`](../modules.md#tsize)\> | Options object |
...
[src/shapes/Image.ts:227](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L227)
...
| `options?` | [`LoadImageOptions`](../modules/util.md#loadimageoptions) | Options object |
...
[src/shapes/Image.ts:464](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L464)
...
[src/shapes/Image.ts:620](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L620)
...
| Name | Type |
| :------ | :------ |
| `T` | extends `Omit`<`Props` & [`TClassProperties`](../modules.md#tclassproperties)<[`Image`](Image.md)<`Props`, `SProps`, `EventSpec`\>\>, keyof `SProps`\> |
...
[src/shapes/Image.ts:325](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L325)
...
[src/shapes/Image.ts:475](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L475)

___

### toggle

▸ **toggle**(`property`): [`Image`](Image.md)<`Props`, `SProps`, `EventSpec`\>
...
▸ `Static` **fromElement**(`element`, `options?`, `cssRules?`): `Promise`<``null`` \| [`Image`](Image.md)<`Partial`<[`ImageProps`](../interfaces/ImageProps.md)\>, [`SerializedImageProps`](../interfaces/SerializedImageProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\>

Returns [Image](Image.md) instance from an SVG element
...
`Promise`<``null`` \| [`Image`](Image.md)<`Partial`<[`ImageProps`](../interfaces/ImageProps.md)\>, [`SerializedImageProps`](../interfaces/SerializedImageProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\>

**`Static`**

#### Defined in

[src/shapes/Image.ts:838](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L838)

___

### fromObject

▸ `Static` **fromObject**<`T`\>(`object`, `options?`): `Promise`<[`Image`](Image.md)<`Omit`<`T`, ``"crossOrigin"`` \| ``"filters"`` \| ``"resizeFilter"`` \| ``"src"``\> & { `filters`: [`BaseFilter`](filters.BaseFilter.md)[] ; `resizeFilter`: `any` ; `src`: `undefined` \| `string`  }, [`SerializedImageProps`](../interfaces/SerializedImageProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\>
...
| Name | Type |
| :------ | :------ |
| `T` | extends [`TOptions`](../modules.md#toptions)<[`SerializedImageProps`](../interfaces/SerializedImageProps.md)\> |
...
`Promise`<[`Image`](Image.md)<`Omit`<`T`, ``"crossOrigin"`` \| ``"filters"`` \| ``"resizeFilter"`` \| ``"src"``\> & { `filters`: [`BaseFilter`](filters.BaseFilter.md)[] ; `resizeFilter`: `any` ; `src`: `undefined` \| `string`  }, [`SerializedImageProps`](../interfaces/SerializedImageProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\>
...
[src/shapes/Image.ts:791](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L791)

___

### fromURL

▸ `Static` **fromURL**<`T`\>(`url`, `«destructured»?`, `imageOptions`): `Promise`<[`Image`](Image.md)<`Partial`<[`ImageProps`](../interfaces/ImageProps.md)\>, [`SerializedImageProps`](../interfaces/SerializedImageProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\>
...
| Name | Type |
| :------ | :------ |
| `T` | extends [`TOptions`](../modules.md#toptions)<[`ImageProps`](../interfaces/ImageProps.md)\> |
...
`Promise`<[`Image`](Image.md)<`Partial`<[`ImageProps`](../interfaces/ImageProps.md)\>, [`SerializedImageProps`](../interfaces/SerializedImageProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\>

**`Static`**

#### Defined in

[src/shapes/Image.ts:820](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L820)
...
[src/shapes/Image.ts:182](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Image.ts#L182)
