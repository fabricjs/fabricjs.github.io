...
[filters](../modules/filters.md).Brightness
...
- [constructor](filters.Brightness.md#constructor)

### Properties

- [brightness](filters.Brightness.md#brightness)
- [mainParameter](filters.Brightness.md#mainparameter)
- [vertexSource](filters.Brightness.md#vertexsource)
- [defaults](filters.Brightness.md#defaults)
- [type](filters.Brightness.md#type)

### Accessors

- [type](filters.Brightness.md#type-1)

### Methods

- [\_setupFrameBuffer](filters.Brightness.md#_setupframebuffer)
- [\_swapTextures](filters.Brightness.md#_swaptextures)
- [applyTo](filters.Brightness.md#applyto)
- [applyTo2d](filters.Brightness.md#applyto2d)
- [applyToWebGL](filters.Brightness.md#applytowebgl)
- [bindAdditionalTexture](filters.Brightness.md#bindadditionaltexture)
- [createHelpLayer](filters.Brightness.md#createhelplayer)
- [createProgram](filters.Brightness.md#createprogram)
- [getAttributeLocations](filters.Brightness.md#getattributelocations)
- [getCacheKey](filters.Brightness.md#getcachekey)
- [getFragmentSource](filters.Brightness.md#getfragmentsource)
- [getMainParameter](filters.Brightness.md#getmainparameter)
- [getUniformLocations](filters.Brightness.md#getuniformlocations)
- [isNeutralState](filters.Brightness.md#isneutralstate)
- [retrieveShader](filters.Brightness.md#retrieveshader)
- [sendAttributeData](filters.Brightness.md#sendattributedata)
- [sendUniformData](filters.Brightness.md#senduniformdata)
- [setMainParameter](filters.Brightness.md#setmainparameter)
- [toJSON](filters.Brightness.md#tojson)
- [toObject](filters.Brightness.md#toobject)
- [unbindAdditionalTexture](filters.Brightness.md#unbindadditionaltexture)
- [fromObject](filters.Brightness.md#fromobject)
...
[src/filters/Brightness.ts:28](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Brightness.ts#L28)

___

### mainParameter

• `Optional` `Private` **mainParameter**: keyof [`Brightness`](filters.Brightness.md)
...
▪ `Static` **defaults**: `Partial`<[`TClassProperties`](../modules.md#tclassproperties)<[`Brightness`](filters.Brightness.md)\>\> = `brightnessDefaultValues`
...
[src/filters/Brightness.ts:32](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Brightness.ts#L32)
...
[src/filters/Brightness.ts:30](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Brightness.ts#L30)
...
[src/filters/Brightness.ts:44](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Brightness.ts#L44)
...
[src/filters/Brightness.ts:34](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Brightness.ts#L34)
...
[src/filters/Brightness.ts:62](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Brightness.ts#L62)
...
[src/filters/Brightness.ts:77](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Brightness.ts#L77)
