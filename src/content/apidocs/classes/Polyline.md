...
- [top](Polyline.md#top)
- [touchCornerSize](Polyline.md#touchcornersize)
...
- [addPaintOrder](Polyline.md#addpaintorder)
...
| Name | Type |
| :------ | :------ |
| `T` | extends [`Polyline`](Polyline.md)<`Props`, `SProps`, `EventSpec`, `T`\> |
| `S` | extends `boolean` |
...
[src/shapes/Polyline.ts:116](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Polyline.ts#L116)
...
| Name | Type |
| :------ | :------ |
| `T` | extends `Omit`<`Props` & [`TClassProperties`](../modules.md#tclassproperties)<[`Polyline`](Polyline.md)<`Props`, `SProps`, `EventSpec`\>\>, keyof `SProps`\> |
...
[src/shapes/Polyline.ts:59](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Polyline.ts#L59)
