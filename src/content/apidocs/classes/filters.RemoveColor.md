...
[filters](../modules/filters.md).RemoveColor
...
- [constructor](filters.RemoveColor.md#constructor)

### Properties

- [color](filters.RemoveColor.md#color)
- [distance](filters.RemoveColor.md#distance)
- [mainParameter](filters.RemoveColor.md#mainparameter)
- [useAlpha](filters.RemoveColor.md#usealpha)
- [vertexSource](filters.RemoveColor.md#vertexsource)
- [defaults](filters.RemoveColor.md#defaults)
- [type](filters.RemoveColor.md#type)

### Accessors

- [type](filters.RemoveColor.md#type-1)

### Methods

- [\_setupFrameBuffer](filters.RemoveColor.md#_setupframebuffer)
- [\_swapTextures](filters.RemoveColor.md#_swaptextures)
- [applyTo](filters.RemoveColor.md#applyto)
- [applyTo2d](filters.RemoveColor.md#applyto2d)
- [applyToWebGL](filters.RemoveColor.md#applytowebgl)
- [bindAdditionalTexture](filters.RemoveColor.md#bindadditionaltexture)
- [createHelpLayer](filters.RemoveColor.md#createhelplayer)
- [createProgram](filters.RemoveColor.md#createprogram)
- [getAttributeLocations](filters.RemoveColor.md#getattributelocations)
- [getCacheKey](filters.RemoveColor.md#getcachekey)
- [getFragmentShader](filters.RemoveColor.md#getfragmentshader)
- [getFragmentSource](filters.RemoveColor.md#getfragmentsource)
- [getMainParameter](filters.RemoveColor.md#getmainparameter)
- [getUniformLocations](filters.RemoveColor.md#getuniformlocations)
- [isNeutralState](filters.RemoveColor.md#isneutralstate)
- [retrieveShader](filters.RemoveColor.md#retrieveshader)
- [sendAttributeData](filters.RemoveColor.md#sendattributedata)
- [sendUniformData](filters.RemoveColor.md#senduniformdata)
- [setMainParameter](filters.RemoveColor.md#setmainparameter)
- [toJSON](filters.RemoveColor.md#tojson)
- [toObject](filters.RemoveColor.md#toobject)
- [unbindAdditionalTexture](filters.RemoveColor.md#unbindadditionaltexture)
- [fromObject](filters.RemoveColor.md#fromobject)
...
Color to remove, in any format understood by [Color](Color.md).
...
[src/filters/RemoveColor.ts:30](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/RemoveColor.ts#L30)
...
[src/filters/RemoveColor.ts:36](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/RemoveColor.ts#L36)

___

### mainParameter

• `Optional` `Private` **mainParameter**: keyof [`RemoveColor`](filters.RemoveColor.md)
...
[src/filters/RemoveColor.ts:42](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/RemoveColor.ts#L42)
...
▪ `Static` **defaults**: `Partial`<[`TClassProperties`](../modules.md#tclassproperties)<[`RemoveColor`](filters.RemoveColor.md)\>\> = `removeColorDefaultValues`
...
[src/filters/RemoveColor.ts:46](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/RemoveColor.ts#L46)
...
[src/filters/RemoveColor.ts:44](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/RemoveColor.ts#L44)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `canvasEl` | [`T2DPipelineState`](../modules.md#t2dpipelinestate) | Canvas element to apply filter to |
...
[src/filters/RemoveColor.ts:56](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/RemoveColor.ts#L56)
...
[src/filters/RemoveColor.ts:48](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/RemoveColor.ts#L48)
...
[src/filters/RemoveColor.ts:90](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/RemoveColor.ts#L90)
...
[src/filters/RemoveColor.ts:106](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/RemoveColor.ts#L106)
...
[src/filters/RemoveColor.ts:132](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/RemoveColor.ts#L132)
