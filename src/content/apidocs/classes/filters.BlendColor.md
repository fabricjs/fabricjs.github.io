...
[filters](../modules/filters.md).BlendColor
...
- [constructor](filters.BlendColor.md#constructor)

### Properties

- [alpha](filters.BlendColor.md#alpha)
- [color](filters.BlendColor.md#color)
- [mainParameter](filters.BlendColor.md#mainparameter)
- [mode](filters.BlendColor.md#mode)
- [vertexSource](filters.BlendColor.md#vertexsource)
- [defaults](filters.BlendColor.md#defaults)
- [type](filters.BlendColor.md#type)

### Accessors

- [type](filters.BlendColor.md#type-1)

### Methods

- [\_setupFrameBuffer](filters.BlendColor.md#_setupframebuffer)
- [\_swapTextures](filters.BlendColor.md#_swaptextures)
- [applyTo](filters.BlendColor.md#applyto)
- [applyTo2d](filters.BlendColor.md#applyto2d)
- [applyToWebGL](filters.BlendColor.md#applytowebgl)
- [bindAdditionalTexture](filters.BlendColor.md#bindadditionaltexture)
- [createHelpLayer](filters.BlendColor.md#createhelplayer)
- [createProgram](filters.BlendColor.md#createprogram)
- [getAttributeLocations](filters.BlendColor.md#getattributelocations)
- [getCacheKey](filters.BlendColor.md#getcachekey)
- [getFragmentSource](filters.BlendColor.md#getfragmentsource)
- [getMainParameter](filters.BlendColor.md#getmainparameter)
- [getUniformLocations](filters.BlendColor.md#getuniformlocations)
- [isNeutralState](filters.BlendColor.md#isneutralstate)
- [retrieveShader](filters.BlendColor.md#retrieveshader)
- [sendAttributeData](filters.BlendColor.md#sendattributedata)
- [sendUniformData](filters.BlendColor.md#senduniformdata)
- [setMainParameter](filters.BlendColor.md#setmainparameter)
- [toJSON](filters.BlendColor.md#tojson)
- [toObject](filters.BlendColor.md#toobject)
- [unbindAdditionalTexture](filters.BlendColor.md#unbindadditionaltexture)
- [fromObject](filters.BlendColor.md#fromobject)
...
[src/filters/BlendColor.ts:65](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/BlendColor.ts#L65)
...
[src/filters/BlendColor.ts:50](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/BlendColor.ts#L50)

___

### mainParameter

• `Optional` `Private` **mainParameter**: keyof [`BlendColor`](filters.BlendColor.md)
...
• **mode**: [`TBlendMode`](../modules/filters.md#tblendmode)
...
[src/filters/BlendColor.ts:58](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/BlendColor.ts#L58)
...
▪ `Static` **defaults**: `Partial`<[`TClassProperties`](../modules.md#tclassproperties)<[`BlendColor`](filters.BlendColor.md)\>\> = `blendColorDefaultValues`
...
[src/filters/BlendColor.ts:67](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/BlendColor.ts#L67)
...
[src/filters/BlendColor.ts:69](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/BlendColor.ts#L69)
...
[src/filters/BlendColor.ts:97](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/BlendColor.ts#L97)
...
[src/filters/BlendColor.ts:71](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/BlendColor.ts#L71)
...
[src/filters/BlendColor.ts:178](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/BlendColor.ts#L178)
...
[src/filters/BlendColor.ts:193](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/BlendColor.ts#L193)
...
[src/filters/BlendColor.ts:209](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/BlendColor.ts#L209)
