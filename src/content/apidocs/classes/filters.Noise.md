...
[filters](../modules/filters.md).Noise
...
- [constructor](filters.Noise.md#constructor)

### Properties

- [mainParameter](filters.Noise.md#mainparameter)
- [noise](filters.Noise.md#noise)
- [vertexSource](filters.Noise.md#vertexsource)
- [defaults](filters.Noise.md#defaults)
- [type](filters.Noise.md#type)

### Accessors

- [type](filters.Noise.md#type-1)

### Methods

- [\_setupFrameBuffer](filters.Noise.md#_setupframebuffer)
- [\_swapTextures](filters.Noise.md#_swaptextures)
- [applyTo](filters.Noise.md#applyto)
- [applyTo2d](filters.Noise.md#applyto2d)
- [applyToWebGL](filters.Noise.md#applytowebgl)
- [bindAdditionalTexture](filters.Noise.md#bindadditionaltexture)
- [createHelpLayer](filters.Noise.md#createhelplayer)
- [createProgram](filters.Noise.md#createprogram)
- [getAttributeLocations](filters.Noise.md#getattributelocations)
- [getCacheKey](filters.Noise.md#getcachekey)
- [getFragmentSource](filters.Noise.md#getfragmentsource)
- [getMainParameter](filters.Noise.md#getmainparameter)
- [getUniformLocations](filters.Noise.md#getuniformlocations)
- [isNeutralState](filters.Noise.md#isneutralstate)
- [retrieveShader](filters.Noise.md#retrieveshader)
- [sendAttributeData](filters.Noise.md#sendattributedata)
- [sendUniformData](filters.Noise.md#senduniformdata)
- [setMainParameter](filters.Noise.md#setmainparameter)
- [toJSON](filters.Noise.md#tojson)
- [toObject](filters.Noise.md#toobject)
- [unbindAdditionalTexture](filters.Noise.md#unbindadditionaltexture)
- [fromObject](filters.Noise.md#fromobject)
...
• `Optional` `Private` **mainParameter**: keyof [`Noise`](filters.Noise.md)
...
[src/filters/Noise.ts:28](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Noise.ts#L28)
...
▪ `Static` **defaults**: `Partial`<[`TClassProperties`](../modules.md#tclassproperties)<[`Noise`](filters.Noise.md)\>\> = `noiseDefaultValues`
...
[src/filters/Noise.ts:32](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Noise.ts#L32)
...
[src/filters/Noise.ts:30](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Noise.ts#L30)
...
[src/filters/Noise.ts:44](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Noise.ts#L44)
...
[src/filters/Noise.ts:63](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Noise.ts#L63)
...
[src/filters/Noise.ts:79](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Noise.ts#L79)
...
[src/filters/Noise.ts:91](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Noise.ts#L91)
