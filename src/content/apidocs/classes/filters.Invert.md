...
[filters](../modules/filters.md).Invert
...
- [constructor](filters.Invert.md#constructor)

### Properties

- [alpha](filters.Invert.md#alpha)
- [invert](filters.Invert.md#invert)
- [mainParameter](filters.Invert.md#mainparameter)
- [vertexSource](filters.Invert.md#vertexsource)
- [defaults](filters.Invert.md#defaults)
- [type](filters.Invert.md#type)

### Accessors

- [type](filters.Invert.md#type-1)

### Methods

- [\_setupFrameBuffer](filters.Invert.md#_setupframebuffer)
- [\_swapTextures](filters.Invert.md#_swaptextures)
- [applyTo](filters.Invert.md#applyto)
- [applyTo2d](filters.Invert.md#applyto2d)
- [applyToWebGL](filters.Invert.md#applytowebgl)
- [bindAdditionalTexture](filters.Invert.md#bindadditionaltexture)
- [createHelpLayer](filters.Invert.md#createhelplayer)
- [createProgram](filters.Invert.md#createprogram)
- [getAttributeLocations](filters.Invert.md#getattributelocations)
- [getCacheKey](filters.Invert.md#getcachekey)
- [getFragmentSource](filters.Invert.md#getfragmentsource)
- [getMainParameter](filters.Invert.md#getmainparameter)
- [getUniformLocations](filters.Invert.md#getuniformlocations)
- [isNeutralState](filters.Invert.md#isneutralstate)
- [retrieveShader](filters.Invert.md#retrieveshader)
- [sendAttributeData](filters.Invert.md#sendattributedata)
- [sendUniformData](filters.Invert.md#senduniformdata)
- [setMainParameter](filters.Invert.md#setmainparameter)
- [toJSON](filters.Invert.md#tojson)
- [toObject](filters.Invert.md#toobject)
- [unbindAdditionalTexture](filters.Invert.md#unbindadditionaltexture)
- [fromObject](filters.Invert.md#fromobject)
...
[src/filters/Invert.ts:25](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Invert.ts#L25)
...
[src/filters/Invert.ts:32](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Invert.ts#L32)

___

### mainParameter

• `Optional` `Private` **mainParameter**: keyof [`Invert`](filters.Invert.md)
...
▪ `Static` **defaults**: `Partial`<[`TClassProperties`](../modules.md#tclassproperties)<[`Invert`](filters.Invert.md)\>\> = `invertDefaultValues`
...
[src/filters/Invert.ts:36](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Invert.ts#L36)
...
[src/filters/Invert.ts:34](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Invert.ts#L34)
...
[src/filters/Invert.ts:44](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Invert.ts#L44)
...
[src/filters/Invert.ts:56](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Invert.ts#L56)

___

### getMainParameter

▸ **getMainParameter**(): `undefined` \| `string` \| `boolean` \| (`gl`: `WebGLRenderingContext`, `program`: `WebGLProgram`) => [`TWebGLAttributeLocationMap`](../modules.md#twebglattributelocationmap) \| (`options`: [`TWebGLPipelineState`](../modules.md#twebglpipelinestate)) => [`TWebGLProgramCacheItem`](../modules.md#twebglprogramcacheitem) \| () => { `type`: `string`  } \| () => { `type`: `string`  } \| (`gl`: `WebGLRenderingContext`, `program`: `WebGLProgram`) => [`TWebGLUniformLocationMap`](../modules.md#twebgluniformlocationmap) \| (`gl`: `WebGLRenderingContext`, `uniformLocations`: [`TWebGLUniformLocationMap`](../modules.md#twebgluniformlocationmap)) => `void` \| () => `string` \| (`options`: [`TWebGLPipelineState`](../modules.md#twebglpipelinestate) \| [`T2DPipelineState`](../modules.md#t2dpipelinestate)) => `void` \| () => `boolean` \| (`options`: [`T2DPipelineState`](../modules.md#t2dpipelinestate)) => `void` \| (`gl`: `WebGLRenderingContext`, `fragmentSource`: `string`, `vertexSource`: `string`) => { `attributeLocations`: [`TWebGLAttributeLocationMap`](../modules.md#twebglattributelocationmap) ; `program`: `WebGLProgram` ; `uniformLocations`: [`TWebGLUniformLocationMap`](../modules.md#twebgluniformlocationmap)  } \| (`gl`: `WebGLRenderingContext`, `attributeLocations`: `Record`<`string`, `number`\>, `aPositionData`: `Float32Array`) => `void` \| (`options`: [`TWebGLPipelineState`](../modules.md#twebglpipelinestate)) => `void` \| (`options`: [`TWebGLPipelineState`](../modules.md#twebglpipelinestate)) => `void` \| (`options`: [`TWebGLPipelineState`](../modules.md#twebglpipelinestate)) => `void` \| (`gl`: `WebGLRenderingContext`, `texture`: `WebGLTexture`, `textureUnit`: `number`) => `void` \| (`gl`: `WebGLRenderingContext`, `textureUnit`: `number`) => `void` \| () => `undefined` \| `string` \| `boolean` \| (`gl`: `WebGLRenderingContext`, `program`: `WebGLProgram`) => [`TWebGLAttributeLocationMap`](../modules.md#twebglattributelocationmap) \| (`options`: [`TWebGLPipelineState`](../modules.md#twebglpipelinestate)) => [`TWebGLProgramCacheItem`](../modules.md#twebglprogramcacheitem) \| () => { `type`: `string`  } \| () => { `type`: `string`  } \| (`gl`: `WebGLRenderingContext`, `program`: `WebGLProgram`) => [`TWebGLUniformLocationMap`](../modules.md#twebgluniformlocationmap) \| (`gl`: `WebGLRenderingContext`, `uniformLocations`: [`TWebGLUniformLocationMap`](../modules.md#twebgluniformlocationmap)) => `void` \| () => `string` \| (`options`: [`TWebGLPipelineState`](../modules.md#twebglpipelinestate) \| [`T2DPipelineState`](../modules.md#t2dpipelinestate)) => `void` \| () => `boolean` \| (`options`: [`T2DPipelineState`](../modules.md#t2dpipelinestate)) => `void` \| (`gl`: `WebGLRenderingContext`, `fragmentSource`: `string`, `vertexSource`: `string`) => { `attributeLocations`: [`TWebGLAttributeLocationMap`](../modules.md#twebglattributelocationmap) ; `program`: `WebGLProgram` ; `uniformLocations`: [`TWebGLUniformLocationMap`](../modules.md#twebgluniformlocationmap)  } \| (`gl`: `WebGLRenderingContext`, `attributeLocations`: `Record`<`string`, `number`\>, `aPositionData`: `Float32Array`) => `void` \| (`options`: [`TWebGLPipelineState`](../modules.md#twebglpipelinestate)) => `void` \| (`options`: [`TWebGLPipelineState`](../modules.md#twebglpipelinestate)) => `void` \| (`options`: [`TWebGLPipelineState`](../modules.md#twebglpipelinestate)) => `void` \| (`gl`: `WebGLRenderingContext`, `texture`: `WebGLTexture`, `textureUnit`: `number`) => `void` \| (`gl`: `WebGLRenderingContext`, `textureUnit`: `number`) => `void` \| () =\> string \| boolean \| ((gl: WebGLRenderingContext, program: WebGLProgram) =\> TWebGLAttributeLocationMap) \| ... 19 more ... \| undefined \| (`value`: `any`) => `void` \| (`options`: [`T2DPipelineState`](../modules.md#t2dpipelinestate)) => `void` \| (`value`: `any`) => `void` \| (`options`: [`T2DPipelineState`](../modules.md#t2dpipelinestate)) => `void`
...
[src/filters/Invert.ts:76](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Invert.ts#L76)
...
[src/filters/Invert.ts:66](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Invert.ts#L66)
...
[src/filters/Invert.ts:92](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Invert.ts#L92)
