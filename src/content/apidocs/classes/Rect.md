...
- [cornerStrokeColor](Rect.md#cornerstrokecolor)
...
- [calcOCoords](Rect.md#calcocoords)
...
[src/shapes/Rect.ts:53](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Rect.ts#L53)
...
| Name | Type |
| :------ | :------ |
| `T` | extends [`Rect`](Rect.md)<`Props`, `SProps`, `EventSpec`, `T`\> |
| `S` | extends `boolean` |
...
| Name | Type |
| :------ | :------ |
| `T` | extends `Omit`<`Props` & [`TClassProperties`](../modules.md#tclassproperties)<[`Rect`](Rect.md)<`Props`, `SProps`, `EventSpec`\>\>, keyof `SProps`\> |
...
[src/shapes/Rect.ts:150](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Rect.ts#L150)
...
▸ `Static` **fromElement**(`element`, `options?`, `cssRules?`): `Promise`<[`Rect`](Rect.md)<{ `height`: `any` ; `left`: `any` ; `signal?`: `AbortSignal` ; `top`: `any` ; `visible`: `boolean` ; `width`: `any`  }, [`SerializedRectProps`](../interfaces/SerializedRectProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\>

Returns [Rect](Rect.md) instance from an SVG element
...
`Promise`<[`Rect`](Rect.md)<{ `height`: `any` ; `left`: `any` ; `signal?`: `AbortSignal` ; `top`: `any` ; `visible`: `boolean` ; `width`: `any`  }, [`SerializedRectProps`](../interfaces/SerializedRectProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\>
...
[src/shapes/Rect.ts:198](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Rect.ts#L198)
...
[src/shapes/Rect.ts:57](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Rect.ts#L57)
