...
- [\_\_corner](Triangle.md#__corner)
- [\_\_owningGroup](Triangle.md#__owninggroup)
- [\_cacheCanvas](Triangle.md#_cachecanvas)
- [\_cacheContext](Triangle.md#_cachecontext)
- [\_controlsVisibility](Triangle.md#_controlsvisibility)
- [\_originalOriginX](Triangle.md#_originaloriginx)
- [\_originalOriginY](Triangle.md#_originaloriginy)
- [\_scaling](Triangle.md#_scaling)
- [\_transformDone](Triangle.md#_transformdone)
- [aCoords](Triangle.md#acoords)
- [absolutePositioned](Triangle.md#absolutepositioned)
- [activeOn](Triangle.md#activeon)
- [angle](Triangle.md#angle)
- [backgroundColor](Triangle.md#backgroundcolor)
- [borderColor](Triangle.md#bordercolor)
- [borderDashArray](Triangle.md#borderdasharray)
- [borderOpacityWhenMoving](Triangle.md#borderopacitywhenmoving)
- [borderScaleFactor](Triangle.md#borderscalefactor)
- [cacheHeight](Triangle.md#cacheheight)
- [cacheTranslationX](Triangle.md#cachetranslationx)
- [cacheTranslationY](Triangle.md#cachetranslationy)
- [cacheWidth](Triangle.md#cachewidth)
- [canvas](Triangle.md#canvas)
- [centeredRotation](Triangle.md#centeredrotation)
- [centeredScaling](Triangle.md#centeredscaling)
- [clipPath](Triangle.md#clippath)
- [clipPathId](Triangle.md#clippathid)
- [colorProperties](Triangle.md#colorproperties)
- [controls](Triangle.md#controls)
- [cornerColor](Triangle.md#cornercolor)
- [cornerDashArray](Triangle.md#cornerdasharray)
- [cornerSize](Triangle.md#cornersize)
- [cornerStrokeColor](Triangle.md#cornerstrokecolor)
- [cornerStyle](Triangle.md#cornerstyle)
- [dirty](Triangle.md#dirty)
- [evented](Triangle.md#evented)
- [excludeFromExport](Triangle.md#excludefromexport)
- [fill](Triangle.md#fill)
- [fillRule](Triangle.md#fillrule)
- [flipX](Triangle.md#flipx)
- [flipY](Triangle.md#flipy)
- [globalCompositeOperation](Triangle.md#globalcompositeoperation)
- [group](Triangle.md#group)
- [hasBorders](Triangle.md#hasborders)
- [hasControls](Triangle.md#hascontrols)
- [height](Triangle.md#height)
- [hoverCursor](Triangle.md#hovercursor)
- [includeDefaultValues](Triangle.md#includedefaultvalues)
- [inverted](Triangle.md#inverted)
- [isMoving](Triangle.md#ismoving)
- [left](Triangle.md#left)
- [lineCoords](Triangle.md#linecoords)
- [lockMovementX](Triangle.md#lockmovementx)
- [lockMovementY](Triangle.md#lockmovementy)
- [lockRotation](Triangle.md#lockrotation)
- [lockScalingFlip](Triangle.md#lockscalingflip)
- [lockScalingX](Triangle.md#lockscalingx)
- [lockScalingY](Triangle.md#lockscalingy)
- [lockSkewingX](Triangle.md#lockskewingx)
- [lockSkewingY](Triangle.md#lockskewingy)
- [matrixCache](Triangle.md#matrixcache)
- [minScaleLimit](Triangle.md#minscalelimit)
- [moveCursor](Triangle.md#movecursor)
- [noScaleCache](Triangle.md#noscalecache)
- [oCoords](Triangle.md#ocoords)
- [objectCaching](Triangle.md#objectcaching)
- [opacity](Triangle.md#opacity)
- [originX](Triangle.md#originx)
- [originY](Triangle.md#originy)
- [ownCaching](Triangle.md#owncaching)
- [ownMatrixCache](Triangle.md#ownmatrixcache)
- [padding](Triangle.md#padding)
- [paintFirst](Triangle.md#paintfirst)
- [perPixelTargetFind](Triangle.md#perpixeltargetfind)
- [scaleX](Triangle.md#scalex)
- [scaleY](Triangle.md#scaley)
- [selectable](Triangle.md#selectable)
- [selectionBackgroundColor](Triangle.md#selectionbackgroundcolor)
- [shadow](Triangle.md#shadow)
- [skewX](Triangle.md#skewx)
- [skewY](Triangle.md#skewy)
- [snapAngle](Triangle.md#snapangle)
- [snapThreshold](Triangle.md#snapthreshold)
- [stroke](Triangle.md#stroke)
- [strokeDashArray](Triangle.md#strokedasharray)
- [strokeDashOffset](Triangle.md#strokedashoffset)
- [strokeLineCap](Triangle.md#strokelinecap)
- [strokeLineJoin](Triangle.md#strokelinejoin)
- [strokeMiterLimit](Triangle.md#strokemiterlimit)
- [strokeUniform](Triangle.md#strokeuniform)
- [strokeWidth](Triangle.md#strokewidth)
- [top](Triangle.md#top)
- [touchCornerSize](Triangle.md#touchcornersize)
- [transparentCorners](Triangle.md#transparentcorners)
- [visible](Triangle.md#visible)
- [width](Triangle.md#width)
- [zoomX](Triangle.md#zoomx)
- [zoomY](Triangle.md#zoomy)
- [cacheProperties](Triangle.md#cacheproperties)
- [ownDefaults](Triangle.md#owndefaults)
- [stateProperties](Triangle.md#stateproperties)
- [type](Triangle.md#type)

### Accessors

- [type](Triangle.md#type-1)

### Methods

- [\_animate](Triangle.md#_animate)
- [\_applyPatternForTransformedGradient](Triangle.md#_applypatternfortransformedgradient)
- [\_applyPatternGradientTransform](Triangle.md#_applypatterngradienttransform)
- [\_calculateCurrentDimensions](Triangle.md#_calculatecurrentdimensions)
- [\_constrainScale](Triangle.md#_constrainscale)
- [\_createBaseClipPathSVGMarkup](Triangle.md#_createbaseclippathsvgmarkup)
- [\_createBaseSVGMarkup](Triangle.md#_createbasesvgmarkup)
- [\_createCacheCanvas](Triangle.md#_createcachecanvas)
- [\_drawBorders](Triangle.md#_drawborders)
- [\_drawClipPath](Triangle.md#_drawclippath)
- [\_findCenterFromElement](Triangle.md#_findcenterfromelement)
- [\_findCrossPoints](Triangle.md#_findcrosspoints)
- [\_findTargetCorner](Triangle.md#_findtargetcorner)
- [\_getCacheCanvasDimensions](Triangle.md#_getcachecanvasdimensions)
- [\_getCoords](Triangle.md#_getcoords)
- [\_getImageLines](Triangle.md#_getimagelines)
- [\_getLeftTopCoords](Triangle.md#_getlefttopcoords)
- [\_getNonTransformedDimensions](Triangle.md#_getnontransformeddimensions)
- [\_getTransformedDimensions](Triangle.md#_gettransformeddimensions)
- [\_limitCacheSize](Triangle.md#_limitcachesize)
- [\_removeCacheCanvas](Triangle.md#_removecachecanvas)
- [\_removeDefaultValues](Triangle.md#_removedefaultvalues)
- [\_removeShadow](Triangle.md#_removeshadow)
- [\_render](Triangle.md#_render)
- [\_renderBackground](Triangle.md#_renderbackground)
- [\_renderControls](Triangle.md#_rendercontrols)
- [\_renderFill](Triangle.md#_renderfill)
- [\_renderPaintInOrder](Triangle.md#_renderpaintinorder)
- [\_renderStroke](Triangle.md#_renderstroke)
- [\_resetOrigin](Triangle.md#_resetorigin)
- [\_set](Triangle.md#_set)
- [\_setClippingProperties](Triangle.md#_setclippingproperties)
- [\_setFillStyles](Triangle.md#_setfillstyles)
- [\_setLineDash](Triangle.md#_setlinedash)
- [\_setObject](Triangle.md#_setobject)
- [\_setOpacity](Triangle.md#_setopacity)
- [\_setOptions](Triangle.md#_setoptions)
- [\_setOriginToCenter](Triangle.md#_setorigintocenter)
- [\_setShadow](Triangle.md#_setshadow)
- [\_setStrokeStyles](Triangle.md#_setstrokestyles)
- [\_setupCompositeOperation](Triangle.md#_setupcompositeoperation)
- [\_toSVG](Triangle.md#_tosvg)
- [\_updateCacheCanvas](Triangle.md#_updatecachecanvas)
- [addPaintOrder](Triangle.md#addpaintorder)
- [animate](Triangle.md#animate)
- [calcACoords](Triangle.md#calcacoords)
- [calcLineCoords](Triangle.md#calclinecoords)
- [calcOCoords](Triangle.md#calcocoords)
- [calcOwnMatrix](Triangle.md#calcownmatrix)
- [calcTransformMatrix](Triangle.md#calctransformmatrix)
- [canDrop](Triangle.md#candrop)
- [clearContextTop](Triangle.md#clearcontexttop)
- [clone](Triangle.md#clone)
- [cloneAsImage](Triangle.md#cloneasimage)
- [complexity](Triangle.md#complexity)
- [containsPoint](Triangle.md#containspoint)
- [dispose](Triangle.md#dispose)
- [drawBorders](Triangle.md#drawborders)
- [drawCacheOnCanvas](Triangle.md#drawcacheoncanvas)
- [drawClipPathOnCache](Triangle.md#drawclippathoncache)
- [drawControls](Triangle.md#drawcontrols)
- [drawControlsConnectingLines](Triangle.md#drawcontrolsconnectinglines)
- [drawObject](Triangle.md#drawobject)
- [drawSelectionBackground](Triangle.md#drawselectionbackground)
- [findCommonAncestors](Triangle.md#findcommonancestors)
- [fire](Triangle.md#fire)
- [forEachControl](Triangle.md#foreachcontrol)
- [get](Triangle.md#get)
- [getActiveControl](Triangle.md#getactivecontrol)
- [getAncestors](Triangle.md#getancestors)
- [getBoundingRect](Triangle.md#getboundingrect)
- [getCanvasRetinaScaling](Triangle.md#getcanvasretinascaling)
- [getCenterPoint](Triangle.md#getcenterpoint)
- [getCoords](Triangle.md#getcoords)
- [getObjectOpacity](Triangle.md#getobjectopacity)
- [getObjectScaling](Triangle.md#getobjectscaling)
- [getParent](Triangle.md#getparent)
- [getPointByOrigin](Triangle.md#getpointbyorigin)
- [getRelativeCenterPoint](Triangle.md#getrelativecenterpoint)
- [getRelativeX](Triangle.md#getrelativex)
- [getRelativeXY](Triangle.md#getrelativexy)
- [getRelativeY](Triangle.md#getrelativey)
- [getScaledHeight](Triangle.md#getscaledheight)
- [getScaledWidth](Triangle.md#getscaledwidth)
- [getSvgCommons](Triangle.md#getsvgcommons)
- [getSvgFilter](Triangle.md#getsvgfilter)
- [getSvgStyles](Triangle.md#getsvgstyles)
- [getSvgTransform](Triangle.md#getsvgtransform)
- [getTotalAngle](Triangle.md#gettotalangle)
- [getTotalObjectScaling](Triangle.md#gettotalobjectscaling)
- [getViewportTransform](Triangle.md#getviewporttransform)
- [getX](Triangle.md#getx)
- [getXY](Triangle.md#getxy)
- [getY](Triangle.md#gety)
- [hasCommonAncestors](Triangle.md#hascommonancestors)
- [hasFill](Triangle.md#hasfill)
- [hasStroke](Triangle.md#hasstroke)
- [intersectsWithObject](Triangle.md#intersectswithobject)
- [intersectsWithRect](Triangle.md#intersectswithrect)
- [isCacheDirty](Triangle.md#iscachedirty)
- [isContainedWithinObject](Triangle.md#iscontainedwithinobject)
- [isContainedWithinRect](Triangle.md#iscontainedwithinrect)
- [isControlVisible](Triangle.md#iscontrolvisible)
- [isDescendantOf](Triangle.md#isdescendantof)
- [isInFrontOf](Triangle.md#isinfrontof)
- [isNotVisible](Triangle.md#isnotvisible)
- [isOnScreen](Triangle.md#isonscreen)
- [isOverlapping](Triangle.md#isoverlapping)
- [isPartiallyOnScreen](Triangle.md#ispartiallyonscreen)
- [isType](Triangle.md#istype)
- [needsItsOwnCache](Triangle.md#needsitsowncache)
- [off](Triangle.md#off)
- [on](Triangle.md#on)
- [onDeselect](Triangle.md#ondeselect)
- [onSelect](Triangle.md#onselect)
- [once](Triangle.md#once)
- [render](Triangle.md#render)
- [renderCache](Triangle.md#rendercache)
- [renderDragSourceEffect](Triangle.md#renderdragsourceeffect)
- [renderDropTargetEffect](Triangle.md#renderdroptargeteffect)
- [rotate](Triangle.md#rotate)
- [scale](Triangle.md#scale)
- [scaleToHeight](Triangle.md#scaletoheight)
- [scaleToWidth](Triangle.md#scaletowidth)
- [set](Triangle.md#set)
- [setControlVisible](Triangle.md#setcontrolvisible)
- [setControlsVisibility](Triangle.md#setcontrolsvisibility)
- [setCoords](Triangle.md#setcoords)
- [setOnGroup](Triangle.md#setongroup)
- [setOptions](Triangle.md#setoptions)
- [setPositionByOrigin](Triangle.md#setpositionbyorigin)
- [setRelativeX](Triangle.md#setrelativex)
- [setRelativeXY](Triangle.md#setrelativexy)
- [setRelativeY](Triangle.md#setrelativey)
- [setX](Triangle.md#setx)
- [setXY](Triangle.md#setxy)
- [setY](Triangle.md#sety)
- [shouldCache](Triangle.md#shouldcache)
- [strokeBorders](Triangle.md#strokeborders)
- [toCanvasElement](Triangle.md#tocanvaselement)
- [toClipPathSVG](Triangle.md#toclippathsvg)
- [toDataURL](Triangle.md#todataurl)
- [toDatalessObject](Triangle.md#todatalessobject)
- [toJSON](Triangle.md#tojson)
- [toObject](Triangle.md#toobject)
- [toSVG](Triangle.md#tosvg)
- [toString](Triangle.md#tostring)
- [toggle](Triangle.md#toggle)
- [transform](Triangle.md#transform)
- [transformMatrixKey](Triangle.md#transformmatrixkey)
- [translateToCenterPoint](Triangle.md#translatetocenterpoint)
- [translateToGivenOrigin](Triangle.md#translatetogivenorigin)
- [translateToOriginPoint](Triangle.md#translatetooriginpoint)
- [willDrawShadow](Triangle.md#willdrawshadow)
- [\_fromObject](Triangle.md#_fromobject)
- [fromObject](Triangle.md#fromobject)
- [getDefaults](Triangle.md#getdefaults)
...
[FabricObjectProps](../interfaces/FabricObjectProps.md).[activeOn](../interfaces/FabricObjectProps.md#activeon)
...
[src/shapes/Triangle.ts:22](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Triangle.ts#L22)
...
[src/shapes/Triangle.ts:20](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Triangle.ts#L20)
...
[src/shapes/Triangle.ts:32](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Triangle.ts#L32)
...
▸ `Protected` **_set**(`key`, `value`): [`Triangle`](Triangle.md)<`Props`, `SProps`, `EventSpec`\>
...
| :------ | :------ |
| `ctx` | `CanvasRenderingContext2D` |
| `«destructured»` | `Pick`<[`Triangle`](Triangle.md)<`Props`, `SProps`, `EventSpec`\>, ``"fill"``\> |
...
[src/shapes/Triangle.ts:50](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Triangle.ts#L50)
...
| Name | Type |
| :------ | :------ |
| `T` | extends [`Triangle`](Triangle.md)<`Props`, `SProps`, `EventSpec`, `T`\> |
| `S` | extends `boolean` |
...
▸ `Protected` **toObject**(`propertiesToInclude?`): `any`
...
[src/shapes/Object/Object.ts:515](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Object/Object.ts#L515)
...
| Name | Type |
| :------ | :------ |
| `T` | extends [`TOptions`](../modules.md#toptions)<[`SerializedObjectProps`](../interfaces/SerializedObjectProps.md)\> |
...
[src/shapes/Object/Object.ts:1580](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Object/Object.ts#L1580)
...
[src/shapes/Triangle.ts:24](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/shapes/Triangle.ts#L24)
