...
[filters](../modules/filters.md).Convolute
...
- [constructor](filters.Convolute.md#constructor)

### Properties

- [mainParameter](filters.Convolute.md#mainparameter)
- [matrix](filters.Convolute.md#matrix)
- [opaque](filters.Convolute.md#opaque)
- [vertexSource](filters.Convolute.md#vertexsource)
- [defaults](filters.Convolute.md#defaults)
- [type](filters.Convolute.md#type)

### Accessors

- [type](filters.Convolute.md#type-1)

### Methods

- [\_setupFrameBuffer](filters.Convolute.md#_setupframebuffer)
- [\_swapTextures](filters.Convolute.md#_swaptextures)
- [applyTo](filters.Convolute.md#applyto)
- [applyTo2d](filters.Convolute.md#applyto2d)
- [applyToWebGL](filters.Convolute.md#applytowebgl)
- [bindAdditionalTexture](filters.Convolute.md#bindadditionaltexture)
- [createHelpLayer](filters.Convolute.md#createhelplayer)
- [createProgram](filters.Convolute.md#createprogram)
- [getAttributeLocations](filters.Convolute.md#getattributelocations)
- [getCacheKey](filters.Convolute.md#getcachekey)
- [getFragmentSource](filters.Convolute.md#getfragmentsource)
- [getMainParameter](filters.Convolute.md#getmainparameter)
- [getUniformLocations](filters.Convolute.md#getuniformlocations)
- [isNeutralState](filters.Convolute.md#isneutralstate)
- [retrieveShader](filters.Convolute.md#retrieveshader)
- [sendAttributeData](filters.Convolute.md#sendattributedata)
- [sendUniformData](filters.Convolute.md#senduniformdata)
- [setMainParameter](filters.Convolute.md#setmainparameter)
- [toJSON](filters.Convolute.md#tojson)
- [toObject](filters.Convolute.md#toobject)
- [unbindAdditionalTexture](filters.Convolute.md#unbindadditionaltexture)
- [fromObject](filters.Convolute.md#fromobject)
...
• `Optional` `Private` **mainParameter**: keyof [`Convolute`](filters.Convolute.md)
...
[src/filters/Convolute.ts:61](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Convolute.ts#L61)
...
[src/filters/Convolute.ts:56](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Convolute.ts#L56)
...
▪ `Static` **defaults**: `Partial`<[`TClassProperties`](../modules.md#tclassproperties)<[`Convolute`](filters.Convolute.md)\>\> = `convoluteDefaultValues`
...
[src/filters/Convolute.ts:65](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Convolute.ts#L65)
...
[src/filters/Convolute.ts:63](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Convolute.ts#L63)
...
[src/filters/Convolute.ts:83](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Convolute.ts#L83)
...
[src/filters/Convolute.ts:67](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Convolute.ts#L67)
...
[src/filters/Convolute.ts:148](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Convolute.ts#L148)
...
[src/filters/Convolute.ts:166](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Convolute.ts#L166)
...
[src/filters/Convolute.ts:177](https://github.com/fabricjs/fabric.js/blob/a4453620e/src/filters/Convolute.ts#L177)
