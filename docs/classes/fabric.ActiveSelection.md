...
## [fabric](fabric.html).ActiveSelection ## [new ActiveSelection()](#ActiveSelection)

Group class

Source:

* [fabric.js](fabric.js.html), [line 20593](fabric.js.html#line20593)

Tutorials:

* *Tutorial: [http://fabricjs.com/fabric-intro-part-3#groups](http://fabricjs.com/fabric-intro-part-3#groups)*

See:

* [fabric.ActiveSelection#initialize](fabric.ActiveSelection.html#initialize) for constructor definition

### Extends

* [fabric.Group](fabric.Group.html)
...
* [fabric.Group#cacheProperties](fabric.Group.html#cacheProperties)
...
* [fabric.js](fabric.js.html), [line 20043](fabric.js.html#line20043)
...
* [fabric.Group#strokeWidth](fabric.Group.html#strokeWidth)

Source:

* [fabric.js](fabric.js.html), [line 20029](fabric.js.html#line20029)

## [subTargetCheck:Boolean](#subTargetCheck)
...
* [fabric.Group#subTargetCheck](fabric.Group.html#subTargetCheck)

Source:

* [fabric.js](fabric.js.html), [line 20036](fabric.js.html#line20036)
...
* [fabric.Group#type](fabric.Group.html#type)
...
* [fabric.js](fabric.js.html), [line 20607](fabric.js.html#line20607)

## [useSetOnGroup:Boolean](#useSetOnGroup)
...
* [fabric.Group#useSetOnGroup](fabric.Group.html#useSetOnGroup)

Source:

* [fabric.js](fabric.js.html), [line 20052](fabric.js.html#line20052)
...
Returns [fabric.ActiveSelection](fabric.ActiveSelection.html) instance from an object representation

##### Parameters:

|Name|Type|Attributes|Description|
|---|---|---|---|
|`object`|Object|Object to create a group from|
|`callback`|function|optional|Callback to invoke when an ActiveSelection instance is created|


Source:

* [fabric.js](fabric.js.html), [line 20730](fabric.js.html#line20730)
...
## [\_renderControls(ctx, styleOverrideopt, childrenOverrideopt)](#_renderControls)
...
|`childrenOverride`|Object|optional|properties to override the children overrides|


Overrides:

* [fabric.Group#\_renderControls](fabric.Group.html#_renderControls)

Source:

* [fabric.js](fabric.js.html), [line 20707](fabric.js.html#line20707)
...
* [fabric.Group#\_toSVG](fabric.Group.html#_toSVG)

Source:

* [fabric.js](fabric.js.html), [line 20509](fabric.js.html#line20509)
...
* [fabric.Group#add](fabric.Group.html#add)
...
## [addWithUpdate(object)&rarr; {[fabric.Group](fabric.Group.html)}](#addWithUpdate)
...
* [fabric.Group#addWithUpdate](fabric.Group.html#addWithUpdate)

Source:

* [fabric.js](fabric.js.html), [line 20152](fabric.js.html#line20152)
...
* [fabric.Group#complexity](fabric.Group.html#complexity)
...
* [fabric.Group#contains](fabric.Group.html#contains)
...
## [destroy()&rarr; {[fabric.Group](fabric.Group.html)}](#destroy)

Destroys a group (restoring state of its objects)

Inherited From:

* [fabric.Group#destroy](fabric.Group.html#destroy)

Source:

* [fabric.js](fabric.js.html), [line 20391](fabric.js.html#line20391)
...
* [fabric.Group#drawObject](fabric.Group.html#drawObject)

Source:

* [fabric.js](fabric.js.html), [line 20336](fabric.js.html#line20336)
...
* [fabric.Group#forEachObject](fabric.Group.html#forEachObject)
...
* [fabric.Group#getObjects](fabric.Group.html#getObjects)
...
## [getSvgStyles()&rarr; {String}](#getSvgStyles)

Returns styles-string for svg-export, specific version for group

Inherited From:

* [fabric.Group#getSvgStyles](fabric.Group.html#getSvgStyles)

Source:

* [fabric.js](fabric.js.html), [line 20523](fabric.js.html#line20523)
...
## [initialize(objects, optionsopt)&rarr; {Object}](#initialize)
...
|Name|Type|Attributes|Description|
|---|---|---|---|
|`objects`|Object|ActiveSelection objects|
|`options`|Object|optional|Options object|


Overrides:

* [fabric.Group#initialize](fabric.Group.html#initialize)

Source:

* [fabric.js](fabric.js.html), [line 20615](fabric.js.html#line20615)
...
* [fabric.Group#insertAt](fabric.Group.html#insertAt)
...
* [fabric.Group#isCacheDirty](fabric.Group.html#isCacheDirty)

Source:

* [fabric.js](fabric.js.html), [line 20346](fabric.js.html#line20346)
...
* [fabric.Group#isEmpty](fabric.Group.html#isEmpty)
...
## [isOnACache()&rarr; {Boolean}](#isOnACache)

Check if this group or its parent group are caching, recursively up

Overrides:

* [fabric.Group#isOnACache](fabric.Group.html#isOnACache)

Source:

* [fabric.js](fabric.js.html), [line 20697](fabric.js.html#line20697)
...
* [fabric.Group#item](fabric.Group.html#item)
...
## [onDeselect()&rarr; {Boolean}](#onDeselect)
...
* [fabric.Group#onDeselect](fabric.Group.html#onDeselect)

Source:

* [fabric.js](fabric.js.html), [line 20668](fabric.js.html#line20668)
...
* [fabric.Group#remove](fabric.Group.html#remove)
...
## [removeWithUpdate(object)&rarr; {[fabric.Group](fabric.Group.html)}](#removeWithUpdate)
...
* [fabric.Group#removeWithUpdate](fabric.Group.html#removeWithUpdate)

Source:

* [fabric.js](fabric.js.html), [line 20183](fabric.js.html#line20183)
...
* [fabric.Group#render](fabric.Group.html#render)

Source:

* [fabric.js](fabric.js.html), [line 20282](fabric.js.html#line20282)
...
## [setObjectsCoords()&rarr; {[fabric.Group](fabric.Group.html)}](#setObjectsCoords)

Sets coordinates of all objects inside group

Inherited From:

* [fabric.Group#setObjectsCoords](fabric.Group.html#setObjectsCoords)

Source:

* [fabric.js](fabric.js.html), [line 20452](fabric.js.html#line20452)
...
* [fabric.Group#shouldCache](fabric.Group.html#shouldCache)

Source:

* [fabric.js](fabric.js.html), [line 20689](fabric.js.html#line20689)
...
* [fabric.Group#size](fabric.Group.html#size)
...
## [toActiveSelection()&rarr; {[fabric.ActiveSelection](fabric.ActiveSelection.html)}](#toActiveSelection)

make a group an active selection, remove the group from canvas the group has to be on canvas for this to work.

Inherited From:

* [fabric.Group#toActiveSelection](fabric.Group.html#toActiveSelection)

Source:

* [fabric.js](fabric.js.html), [line 20414](fabric.js.html#line20414)
...
[fabric.ActiveSelection](fabric.ActiveSelection.html)
...
* [fabric.Group#toClipPathSVG](fabric.Group.html#toClipPathSVG)

Source:

* [fabric.js](fabric.js.html), [line 20539](fabric.js.html#line20539)
...
* [fabric.Group#toDatalessObject](fabric.Group.html#toDatalessObject)

Source:

* [fabric.js](fabric.js.html), [line 20258](fabric.js.html#line20258)
...
## [toGroup()&rarr; {[fabric.Group](fabric.Group.html)}](#toGroup)

Change te activeSelection to a normal group, High level function that automatically adds it to canvas as active object. no events fired.
...
* [fabric.js](fabric.js.html), [line 20641](fabric.js.html#line20641)
...
* [fabric.Group#toObject](fabric.Group.html#toObject)

Source:

* [fabric.js](fabric.js.html), [line 20235](fabric.js.html#line20235)
...
* [fabric.Group#toString](fabric.Group.html#toString)

Source:

* [fabric.js](fabric.js.html), [line 20677](fabric.js.html#line20677)
...
## [ungroupOnCanvas()&rarr; {[fabric.Group](fabric.Group.html)}](#ungroupOnCanvas)

Destroys a group (restoring state of its objects)

Inherited From:

* [fabric.Group#ungroupOnCanvas](fabric.Group.html#ungroupOnCanvas)

Source:

* [fabric.js](fabric.js.html), [line 20443](fabric.js.html#line20443)
...
* [fabric.Group#willDrawShadow](fabric.Group.html#willDrawShadow)

Source:

* [fabric.js](fabric.js.html), [line 20312](fabric.js.html#line20312)
